// Package TestEncryptDecrypt
// Dafny module TestEncryptDecrypt compiled into Go
...
func (*Default__) String() string {
	return "TestEncryptDecrypt.Default__"
}
...
func (_static *CompanionStruct_Default___) TestEncryptDecrypt() {
	...
	if !(!((_3_valueOrError0).IsFailure())) {
		panic("dafny/AwsEncryptionSdk/test/TestEncryptDecrypt.dfy(24,20): " + (_3_valueOrError0).String())
	}
	...
	if !(!((_5_valueOrError1).IsFailure())) {
		panic("dafny/AwsEncryptionSdk/test/TestEncryptDecrypt.dfy(25,19): " + (_5_valueOrError1).String())
	}
	...
	if !(!((_7_valueOrError2).IsFailure())) {
		panic("dafny/AwsEncryptionSdk/test/TestEncryptDecrypt.dfy(26,30): " + (_7_valueOrError2).String())
	}
	...
	if !(!((_9_valueOrError3).IsFailure())) {
		panic("dafny/AwsEncryptionSdk/test/TestEncryptDecrypt.dfy(27,25): " + (_9_valueOrError3).String())
	}
	...
	if !(!((_11_valueOrError4).IsFailure())) {
		panic("dafny/AwsEncryptionSdk/test/TestEncryptDecrypt.dfy(29,26): " + (_11_valueOrError4).String())
	}
	...
	_ = _out5
	_out5 = (_4_esdk).Encrypt(m_AwsCryptographyEncryptionSdkTypes.Companion_EncryptInput_.Create_EncryptInput_(_1_asdf, m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_Some_(_12_kmsKeyring), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_()))
	_13_encryptOutput = _out5
	if !((_13_encryptOutput).Is_Success()) {
		panic("dafny/AwsEncryptionSdk/test/TestEncryptDecrypt.dfy(46,8): " + (_dafny.SeqOfString("expectation violation")).String())
	}
	...
	_ = _out6
	_out6 = (_4_esdk).Decrypt(m_AwsCryptographyEncryptionSdkTypes.Companion_DecryptInput_.Create_DecryptInput_(_14_esdkCiphertext, m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_Some_(_12_kmsKeyring), m_Wrappers.Companion_Option_.Create_None_()))
	_15_decryptOutput = _out6
	if !((_15_decryptOutput).Is_Success()) {
		panic("dafny/AwsEncryptionSdk/test/TestEncryptDecrypt.dfy(56,8): " + (_dafny.SeqOfString("expectation violation")).String())
	}
	...
	if !(_dafny.Companion_Sequence_.Equal(_16_cycledPlaintext, _1_asdf)) {
		panic("dafny/AwsEncryptionSdk/test/TestEncryptDecrypt.dfy(59,8): " + (_dafny.SeqOfString("expectation violation")).String())
	}
}
