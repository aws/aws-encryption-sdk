module github.com/aws/aws-encryption-sdk/releases/go/encryption-sdk/test
...
replace github.com/aws/aws-encryption-sdk/releases/go/encryption-sdk v0.0.0 => ../ImplementationFromDafny-go
