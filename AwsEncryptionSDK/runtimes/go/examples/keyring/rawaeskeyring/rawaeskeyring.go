...
This example creates a Raw AES Keyring and then encrypts a custom input exampleText
...
func RawAesExample(exampleText string) {
	...
	fmt.Println("Raw AES Keyring Example Completed Successfully")
}
