...
func AwsKmsKeyringExample(exampleText string, defaultKmsKeyId string, defaultKMSKeyAccountID string) {
	...
	fmt.Println("AWS KMS Keyring Example Completed Successfully")
}
