...
*/
package awskmsmrkdiscoverymultikeyring
...
func AwsKmsMrkDiscoveryMultiKeyringExample(exampleText, defaultRegionMrkKeyArn, defaultMRKKeyRegion, defaultKMSKeyAccountID string, regionsOfMRKKeys []string) {
	...
	// Second Keyring: Create a MRK Discovery Multi Keyring to use for decryption
	...
	fmt.Println("AWS KMS MRK Discovery Multi Keyring Example Completed Successfully")
}
