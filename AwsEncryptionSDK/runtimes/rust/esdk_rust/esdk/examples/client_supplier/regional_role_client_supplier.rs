...
use aws_mpl_legacy::com_amazonaws_kms::client::Client as kms_client;
use aws_mpl_legacy::operation::get_client::GetClientInput;
use aws_mpl_legacy::types::ClientSupplier;
