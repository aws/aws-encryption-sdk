...
use aws_mpl_rs::operation::get_branch_key_id::GetBranchKeyIdInput;
use aws_mpl_rs::operation::get_branch_key_id::GetBranchKeyIdOutput;
use aws_mpl_rs::types::branch_key_id_supplier::BranchKeyIdSupplier;
...
impl BranchKeyIdSupplier for ExampleBranchKeyIdSupplier {
    fn get_branch_key_id(&self, input: GetBranchKeyIdInput) -> Result<GetBranchKeyIdOutput, Error> {
        let encryption_context = input.encryption_context.unwrap();
