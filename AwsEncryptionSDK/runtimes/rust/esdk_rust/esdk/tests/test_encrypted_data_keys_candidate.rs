...
struct ParsedEdkSection {
    edk_count_offset: usize,
    edk_count: u16,
    edks: Vec<ParsedEdk>,
...
fn skip_to_edk_section(ct: &[u8], version: Version) -> usize {
...
fn parse_edk_section(ct: &[u8], version: Version) -> ParsedEdkSection {
