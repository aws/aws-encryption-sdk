...
use aws_esdk::implementation_from_dafny::software::amazon::cryptography::primitives::internaldafny::types::ECDHCurveSpec;
use aws_esdk::ecdh::ECDH::ECCUtils::X962_to_X509;

// Function to get internal dafny type for ECDH Curve; to use the extern function X962_to_X509
fn get_ecdh_curve_internal_dafny_type(x: EcdhCurveSpec) -> ECDHCurveSpec {
    match x {
        EcdhCurveSpec::EccNistP256 {} => ECDHCurveSpec::ECC_NIST_P256 {},
        EcdhCurveSpec::EccNistP384 {} => ECDHCurveSpec::ECC_NIST_P384 {},
        EcdhCurveSpec::EccNistP521 {} => ECDHCurveSpec::ECC_NIST_P521 {},
...
fn generate_raw_ecc_key_pair(
    ...
    let public_key: Vec<u8> = X962_to_X509(public_key.as_ref(), &get_ecdh_curve_internal_dafny_type(ecdh_curve_spec))?;
