...
class AwsEncryptionSdkConfig(Config):
    ...
    def __init__(
        ...
        :param net_v4_0_0_retry_policy: During Decryption, Allow or Forbid ESDK-NET
        v4.0.0 Behavior if the ESDK Message Header fails the Header Authentication
        check.
        """
        super().__init__()
...
def dafny_config_to_smithy_config(dafny_config) -> AwsEncryptionSdkConfig:
    ...
    """
    return aws_encryption_sdk.smithygenerated.aws_cryptography_encryptionsdk.dafny_to_smithy.aws_cryptography_encryptionsdk_AwsEncryptionSdkConfig(dafny_config)
...
def smithy_config_to_dafny_config(smithy_config) -> DafnyAwsEncryptionSdkConfig:
    ...
    """
    return aws_encryption_sdk.smithygenerated.aws_cryptography_encryptionsdk.smithy_to_dafny.aws_cryptography_encryptionsdk_AwsEncryptionSdkConfig(smithy_config)
