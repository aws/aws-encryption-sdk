...
def dafny_config_to_smithy_config(dafny_config) -> AwsEncryptionSdkConfig:
    ...
    return aws_encryption_sdk_python_dafny.smithygenerated.aws_cryptography_encryptionsdk.dafny_to_smithy.aws_cryptography_encryptionsdk_AwsEncryptionSdkConfig(
        dafny_config
    )
...
def smithy_config_to_dafny_config(smithy_config) -> DafnyAwsEncryptionSdkConfig:
    ...
    return aws_encryption_sdk_python_dafny.smithygenerated.aws_cryptography_encryptionsdk.smithy_to_dafny.aws_cryptography_encryptionsdk_AwsEncryptionSdkConfig(
        smithy_config
    )
