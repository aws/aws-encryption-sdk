...
from aws_encryption_sdk_python_dafny.internaldafny.generated.AwsCryptographyEncryptionSdkTypes import (
    NetV4_0_0_RetryPolicy_ALLOW__RETRY,
    NetV4_0_0_RetryPolicy_FORBID__RETRY,
)
import aws_encryption_sdk_python_dafny.internaldafny.generated.module_
import aws_encryption_sdk_python_dafny.smithygenerated.aws_cryptography_encryptionsdk.dafny_to_smithy
import aws_encryption_sdk_python_dafny.smithygenerated.aws_cryptography_encryptionsdk.models


def aws_cryptography_encryptionsdk_EncryptInput(dafny_input):
    return aws_encryption_sdk_python_dafny.smithygenerated.aws_cryptography_encryptionsdk.models.EncryptInput(
...
def aws_cryptography_encryptionsdk_DecryptInput(dafny_input):
    return aws_encryption_sdk_python_dafny.smithygenerated.aws_cryptography_encryptionsdk.models.DecryptInput(
...
def aws_cryptography_encryptionsdk_EncryptOutput(dafny_input):
    return aws_encryption_sdk_python_dafny.smithygenerated.aws_cryptography_encryptionsdk.models.EncryptOutput(
        ciphertext=bytes(dafny_input.ciphertext),
        encryption_context={
...
def aws_cryptography_encryptionsdk_DecryptOutput(dafny_input):
    return aws_encryption_sdk_python_dafny.smithygenerated.aws_cryptography_encryptionsdk.models.DecryptOutput(
        plaintext=bytes(dafny_input.plaintext),
        encryption_context={
            bytes(key.Elements).decode("utf-8"): bytes(value.Elements).decode("utf-8")
            for (key, value) in dafny_input.encryptionContext.items
...
def aws_cryptography_encryptionsdk_AwsEncryptionSdkConfig(dafny_input):
    ...
    import aws_encryption_sdk_python_dafny.smithygenerated.aws_cryptography_encryptionsdk.config

    return aws_encryption_sdk_python_dafny.smithygenerated.aws_cryptography_encryptionsdk.config.AwsEncryptionSdkConfig(
        commitment_policy=(
            (
        ...
        net_v4_0_0_retry_policy=(
            (
                aws_encryption_sdk_python_dafny.smithygenerated.aws_cryptography_encryptionsdk.dafny_to_smithy.aws_cryptography_encryptionsdk_NetV4_0_0_RetryPolicy(
