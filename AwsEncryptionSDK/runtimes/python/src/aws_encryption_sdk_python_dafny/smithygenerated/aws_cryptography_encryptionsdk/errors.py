...
import aws_encryption_sdk_python_dafny.internaldafny.generated
import aws_encryption_sdk_python_dafny.internaldafny.generated.AwsCryptographyEncryptionSdkTypes
import aws_encryption_sdk_python_dafny.smithygenerated.aws_cryptography_encryptionsdk.errors
...
class AwsEncryptionSdkException(ApiError[Literal["AwsEncryptionSdkException"]]):
    code: Literal["AwsEncryptionSdkException"] = "AwsEncryptionSdkException"
    message: str
    ...
    def as_dict(self) -> Dict[str, Any]:
        """Converts the AwsEncryptionSdkException to a dictionary."""
        return {
    ...
    def from_dict(d: Dict[str, Any]) -> "AwsEncryptionSdkException":
        """Creates a AwsEncryptionSdkException from a dictionary."""
        kwargs: Dict[str, Any] = {
            "message": d["message"],
        }

        return AwsEncryptionSdkException(**kwargs)

    def __repr__(self) -> str:
        result = "AwsEncryptionSdkException("
    ...
    def __eq__(self, other: Any) -> bool:
        if not isinstance(other, AwsEncryptionSdkException):
            return False
        attributes: list[str] = [
            "message",
            "message",
...
def _smithy_error_to_dafny_error(e: ServiceError):
    ...
    if isinstance(
        e,
        aws_encryption_sdk_python_dafny.smithygenerated.aws_cryptography_encryptionsdk.errors.AwsEncryptionSdkException,
    ):
        return aws_encryption_sdk_python_dafny.internaldafny.generated.AwsCryptographyEncryptionSdkTypes.Error_AwsEncryptionSdkException(
            message=_dafny.Seq(e.message)
        )

    if isinstance(e, AwsCryptographicPrimitives):
        return aws_encryption_sdk_python_dafny.internaldafny.generated.AwsCryptographyEncryptionSdkTypes.Error_AwsCryptographyPrimitives(
            aws_cryptography_primitives_smithy_error_to_dafny_error(e.message)
        )

    if isinstance(e, AwsCryptographicMaterialProviders):
        return aws_encryption_sdk_python_dafny.internaldafny.generated.AwsCryptographyEncryptionSdkTypes.Error_AwsCryptographyMaterialProviders(
            aws_cryptography_materialproviders_smithy_error_to_dafny_error(e.message)
        )

    if isinstance(e, CollectionOfErrors):
        return aws_encryption_sdk_python_dafny.internaldafny.generated.AwsCryptographyEncryptionSdkTypes.Error_CollectionOfErrors(
            message=_dafny.Seq(e.message),
            list=_dafny.Seq(
    ...
    if isinstance(e, OpaqueError):
        return aws_encryption_sdk_python_dafny.internaldafny.generated.AwsCryptographyEncryptionSdkTypes.Error_Opaque(
            obj=e.obj
        )
