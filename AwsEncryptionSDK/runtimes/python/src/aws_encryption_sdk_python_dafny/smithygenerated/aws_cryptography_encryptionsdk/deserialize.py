...
def _deserialize_encrypt(input: DafnyResponse, config: Config):
    ...
    return aws_encryption_sdk_python_dafny.smithygenerated.aws_cryptography_encryptionsdk.dafny_to_smithy.aws_cryptography_encryptionsdk_EncryptOutput(
        input.value
    )
...
def _deserialize_decrypt(input: DafnyResponse, config: Config):
    ...
    if input.IsFailure():
        return _deserialize_error(input.error)
    return aws_encryption_sdk_python_dafny.smithygenerated.aws_cryptography_encryptionsdk.dafny_to_smithy.aws_cryptography_encryptionsdk_DecryptOutput(
        input.value
    )
