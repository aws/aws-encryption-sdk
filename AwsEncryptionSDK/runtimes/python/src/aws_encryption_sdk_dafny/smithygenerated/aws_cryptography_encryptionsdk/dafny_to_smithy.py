...
def aws_cryptography_encryptionsdk_DecryptInput(dafny_input):
    return aws_encryption_sdk_dafny.smithygenerated.aws_cryptography_encryptionsdk.models.DecryptInput(
...
def aws_cryptography_encryptionsdk_DecryptOutput(dafny_input):
    return aws_encryption_sdk_dafny.smithygenerated.aws_cryptography_encryptionsdk.models.DecryptOutput(
        plaintext=bytes(dafny_input.plaintext),
        encryption_context={
            bytes(key.Elements).decode("utf-8"): bytes(value.Elements).decode("utf-8")
            for (key, value) in dafny_input.encryptionContext.items
...
def aws_cryptography_encryptionsdk_AtomicPrimitivesReference(dafny_input):
...
def aws_cryptography_encryptionsdk_AwsEncryptionSdkConfig(dafny_input):
    ...
    return aws_encryption_sdk_dafny.smithygenerated.aws_cryptography_encryptionsdk.config.AwsEncryptionSdkConfig(
        commitment_policy=(
            (
...
def aws_cryptography_encryptionsdk_MaterialProvidersReference(dafny_input):
