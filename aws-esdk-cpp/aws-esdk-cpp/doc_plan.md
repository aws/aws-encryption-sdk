...
•	aws-esdk-cpp/ — single lib.rs file exposing encrypt/decrypt, hierarchical keyring creation, keystore, KMS/DDB client lifecycle to C++ via the cxx crate. This can be used today to create and use a hierarchy keyring in C++. 
