...
class ManifestOptions:
    ...
    @property
    def is_DecryptSingle(self) -> bool:
        return isinstance(self, ManifestOptions_DecryptSingle)
    @property
...
class ManifestOptions_Encrypt(ManifestOptions, NamedTuple('Encrypt', [('manifestPath', Any), ('manifest', Any), ('decryptManifestOutput', Any), ('testName', Any)])):
    def __dafnystr__(self) -> str:
        return f'EsdkManifestOptions.ManifestOptions.Encrypt({_dafny.string_of(self.manifestPath)}, {_dafny.string_of(self.manifest)}, {_dafny.string_of(self.decryptManifestOutput)}, {_dafny.string_of(self.testName)})'
    def __eq__(self, __o: object) -> bool:
        return isinstance(__o, ManifestOptions_Encrypt) and self.manifestPath == __o.manifestPath and self.manifest == __o.manifest and self.decryptManifestOutput == __o.decryptManifestOutput and self.testName == __o.testName
    def __hash__(self) -> int:
        return super().__hash__()

class ManifestOptions_DecryptSingle(ManifestOptions, NamedTuple('DecryptSingle', [('keysPath', Any), ('keyDescription', Any), ('base64Bytes', Any)])):
    def __dafnystr__(self) -> str:
        return f'EsdkManifestOptions.ManifestOptions.DecryptSingle({_dafny.string_of(self.keysPath)}, {_dafny.string_of(self.keyDescription)}, {_dafny.string_of(self.base64Bytes)})'
    def __eq__(self, __o: object) -> bool:
        return isinstance(__o, ManifestOptions_DecryptSingle) and self.keysPath == __o.keysPath and self.keyDescription == __o.keyDescription and self.base64Bytes == __o.base64Bytes
    def __hash__(self) -> int:
        return super().__hash__()

class ManifestOptions_EncryptManifest(ManifestOptions, NamedTuple('EncryptManifest', [('encryptManifestOutput', Any), ('version', Any)])):
    def __dafnystr__(self) -> str:
        return f'EsdkManifestOptions.ManifestOptions.EncryptManifest({_dafny.string_of(self.encryptManifestOutput)}, {_dafny.string_of(self.version)})'
    def __eq__(self, __o: object) -> bool:
        return isinstance(__o, ManifestOptions_EncryptManifest) and self.encryptManifestOutput == __o.encryptManifestOutput and self.version == __o.version
    def __hash__(self) -> int:
        return super().__hash__()
