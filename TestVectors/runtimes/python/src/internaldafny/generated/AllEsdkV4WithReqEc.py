...
class default__:
    ...
    def AllPositiveReqEcTests(instance):
        return AllRequiredEncryptionContextCmm.default__.SuccessTestingRequiredEncryptionContextKeysReproducedEncryptionContext
    @_dafny.classproperty
    def frameSize(instance):
        return 512
    @_dafny.classproperty
    def AllPositiveReqEcEsdkTests(instance):
        def iife0_():
            coll0_ = _dafny.Set()
            compr_0_: TestVectors.EncryptTestVector
            for compr_0_ in (default__.AllPositiveReqEcTests).Elements:
                d_0_config_: TestVectors.EncryptTestVector = compr_0_
                if (d_0_config_) in (default__.AllPositiveReqEcTests):
