...
from aws_encryption_sdk_dafny.smithygenerated.aws_cryptography_encryptionsdk.config import dafny_config_to_smithy_config
...
class DafnyESDKToNativeESDKShim:
  ...
  def Encrypt(self, dafny_encrypt_input):
    ...
    dafny_esdk_dafny_encrypt_output = smithy_to_dafny_EncryptOutput(dafny_esdk_native_encrypt_output)
  ...
  def Decrypt(self, dafny_decrypt_input):
    ...
    dafny_esdk_dafny_decrypt_output = smithy_to_dafny_DecryptOutput(dafny_esdk_native_decrypt_output)
...
class default__(WrappedESDK.default__):
  ...
  def WrappedESDK(dafny_config):
    ...
    commitment_policy = _esdk_dafny_commitment_policy_to_native(native_config.commitment_policy)

    max_edks = 1 if native_config.max_encrypted_data_keys == 0 else native_config.max_encrypted_data_keys
