...
class default__:
    ...
    def AllPositiveKeyringTestsNoReqCmmNoKmsRsa(instance):
        return ((((((((((_dafny.Set({})) | (AllDefaultCmm.default__.SuccessTestingRequiredEncryptionContextKeysReproducedEncryptionContext)) | (AllHierarchy.default__.Tests)) | (AllKms.default__.Tests)) | (AllKmsMrkAware.default__.Tests)) | (AllKmsMrkAwareDiscovery.default__.Tests)) | (AllRawAES.default__.Tests)) | (AllRawRSA.default__.Tests)) | (AllMulti.default__.Tests)) | (AllRawECDH.default__.Tests)) | (AllKmsEcdh.default__.Tests)
    @_dafny.classproperty
    def frameSize(instance):
        return 512
    @_dafny.classproperty
    def AllPostiveKeyringTestsNoDBESuiteNoReqEC(instance):
        def iife0_():
            coll0_ = _dafny.Set()
            compr_0_: TestVectors.EncryptTestVector
            for compr_0_ in (default__.AllPositiveKeyringTestsNoReqCmmNoKmsRsa).Elements:
                d_0_keyringConfig_: TestVectors.EncryptTestVector = compr_0_
                if ((d_0_keyringConfig_) in (default__.AllPositiveKeyringTestsNoReqCmmNoKmsRsa)) and (not((d_0_keyringConfig_).is_NegativeEncryptKeyringVector)):
                    compr_1_: AwsCryptographyMaterialProvidersTypes.AlgorithmSuiteInfo
                    for compr_1_ in (AllAlgorithmSuites.default__.ESDKAlgorithmSuites).Elements:
                        d_1_algorithmSuite_: AwsCryptographyMaterialProvidersTypes.AlgorithmSuiteInfo = compr_1_
                        if (d_1_algorithmSuite_) in (AllAlgorithmSuites.default__.ESDKAlgorithmSuites):
                            coll0_ = coll0_.union(_dafny.Set([EsdkTestVectors.EsdkEncryptTestVector_PositiveEncryptTestVector(Wrappers.Option_None(), 4, _dafny.Seq(""), _dafny.Seq(""), _dafny.Seq(""), (d_0_keyringConfig_).encryptDescription, (d_0_keyringConfig_).decryptDescription, Wrappers.Option_None(), Wrappers.Option_None(), AwsCryptographyMaterialProvidersTypes.ESDKCommitmentPolicy_FORBID__ENCRYPT__ALLOW__DECRYPT(), Wrappers.Option_Some(default__.frameSize), Wrappers.Option_Some(d_1_algorithmSuite_), (d_0_keyringConfig_).name, Wrappers.Option_Some(1))]))
            return _dafny.Set(coll0_)
        return iife0_()
        
    @_dafny.classproperty
    def AwsKmsRsaTests(instance):
        return AllKmsRsa.default__.Tests
    @_dafny.classproperty
    def esdkAlgorithmSuitesKmsRsa(instance):
        def iife0_():
            coll0_ = _dafny.Set()
            compr_0_: AwsCryptographyMaterialProvidersTypes.AlgorithmSuiteInfo
            for compr_0_ in (AllAlgorithmSuites.default__.AllAlgorithmSuites).Elements:
                d_0_suite_: AwsCryptographyMaterialProvidersTypes.AlgorithmSuiteInfo = compr_0_
                if AlgorithmSuites.AlgorithmSuite._Is(d_0_suite_):
                    if (((d_0_suite_) in (AllAlgorithmSuites.default__.AllAlgorithmSuites)) and (not(((d_0_suite_).signature).is_ECDSA))) and (((d_0_suite_).id).is_ESDK):
                        coll0_ = coll0_.union(_dafny.Set([d_0_suite_]))
            return _dafny.Set(coll0_)
        return iife0_()
        
    @_dafny.classproperty
    def AllPositiveKeyringTestsNoDBEKmsRsa(instance):
        def iife0_():
            coll0_ = _dafny.Set()
            compr_0_: TestVectors.EncryptTestVector
            for compr_0_ in (default__.AwsKmsRsaTests).Elements:
                d_0_keyringConfig_: TestVectors.EncryptTestVector = compr_0_
                if ((d_0_keyringConfig_) in (default__.AwsKmsRsaTests)) and (not((d_0_keyringConfig_).is_NegativeEncryptKeyringVector)):
                    compr_1_: AwsCryptographyMaterialProvidersTypes.AlgorithmSuiteInfo
                    for compr_1_ in (default__.esdkAlgorithmSuitesKmsRsa).Elements:
                        d_1_algorithmSuite_: AwsCryptographyMaterialProvidersTypes.AlgorithmSuiteInfo = compr_1_
                        if (d_1_algorithmSuite_) in (default__.esdkAlgorithmSuitesKmsRsa):
                            coll0_ = coll0_.union(_dafny.Set([EsdkTestVectors.EsdkEncryptTestVector_PositiveEncryptTestVector(Wrappers.Option_None(), 4, _dafny.Seq(""), _dafny.Seq(""), _dafny.Seq(""), (d_0_keyringConfig_).encryptDescription, (d_0_keyringConfig_).decryptDescription, Wrappers.Option_None(), Wrappers.Option_None(), AwsCryptographyMaterialProvidersTypes.ESDKCommitmentPolicy_FORBID__ENCRYPT__ALLOW__DECRYPT(), Wrappers.Option_Some(default__.frameSize), Wrappers.Option_Some(d_1_algorithmSuite_), (d_0_keyringConfig_).name, Wrappers.Option_Some(1))]))
            return _dafny.Set(coll0_)
        return iife0_()
    ...
    @_dafny.classproperty
    def Tests(instance):
        return (default__.AllPostiveKeyringTestsNoDBESuiteNoReqEC) | (default__.AllPositiveKeyringTestsNoDBEKmsRsa)
