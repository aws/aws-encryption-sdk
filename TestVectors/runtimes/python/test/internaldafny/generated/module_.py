...
import TestWrappedESDKMain as TestWrappedESDKMain
...
class default__:
    ...
    def Test____Main____(noArgsParameter__):
        d_0_success_: bool
        d_0_success_ = True
        _dafny.print(_dafny.string_of(_dafny.Seq("TestWrappedESDKMain.RunManifestTests: ")))
        try:
            if True:
                TestWrappedESDKMain.default__.RunManifestTests()
                if True:
