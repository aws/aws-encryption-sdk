// Package TestWrappedESDKMain
// Dafny module TestWrappedESDKMain compiled into Go
...
import (
	...
	m_WrappedESDKMain "github.com/aws/aws-encryption-sdk/testvectors/WrappedESDKMain"
...
var _ m_WrappedESDKMain.Dummy__
...
func (*Default__) String() string {
	return "TestWrappedESDKMain.Default__"
}
...
func (_static *CompanionStruct_Default___) TestNetRetryFlagVectorsExpectSuccess() {
	var _0_directory _dafny.Sequence
	_ = _0_directory
	var _out0 _dafny.Sequence
	_ = _out0
	_out0 = m_TestWrappedESDKMain.GetTestVectorExecutionDirectory()
	_0_directory = _out0
	var _1_result m_Wrappers.Result
	_ = _1_result
	var _out1 m_Wrappers.Result
	_ = _out1
	_out1 = m_EsdkTestManifests.Companion_Default___.StartDecryptVectors(m_EsdkManifestOptions.Companion_ManifestOptions_.Create_Decrypt_(_dafny.Companion_Sequence_.Concatenate(_0_directory, _dafny.SeqOfString("dafny/TestVectors/test/valid-Net-4.0.0/")), _dafny.SeqOfString("manifest.json"), m_AwsCryptographyEncryptionSdkTypes.Companion_NetV4__0__0__RetryPolicy_.Create_FORBID__RETRY_(), m_Wrappers.Companion_Option_.Create_None_()))
	_1_result = _out1
	if (_1_result).Is_Failure() {
		_dafny.Print(((_1_result).Dtor_error().(_dafny.Sequence)).SetString())
	}
	if !((_1_result).Is_Success()) {
		panic("dafny/TestVectors/test/RunMain.dfy(44,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
}
func (_static *CompanionStruct_Default___) TestNetInvalidTestVectorsExpectFailure() {
	var _0_directory _dafny.Sequence
	_ = _0_directory
	var _out0 _dafny.Sequence
	_ = _out0
	...
	var _out1 m_Wrappers.Result
	_ = _out1
	_out1 = m_EsdkTestManifests.Companion_Default___.StartDecryptVectors(m_EsdkManifestOptions.Companion_ManifestOptions_.Create_Decrypt_(_dafny.Companion_Sequence_.Concatenate(_0_directory, _dafny.SeqOfString("dafny/TestVectors/test/invalid-Net-4.0.0/")), _dafny.SeqOfString("manifest.json"), m_AwsCryptographyEncryptionSdkTypes.Companion_NetV4__0__0__RetryPolicy_.Create_FORBID__RETRY_(), m_Wrappers.Companion_Option_.Create_None_()))
	_1_result = _out1
	_dafny.Print((_dafny.SeqOfString("ONLY WORRY IF THE ABOVE TESTS PASSED!!! THESE TESTS ARE SUPPOSED TO FAIL!\n")).SetString())
	if !((_1_result).Is_Failure()) {
		panic("dafny/TestVectors/test/RunMain.dfy(66,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
}
func (_static *CompanionStruct_Default___) TestNetInvalidTestVectorsExpectSuccessOnRetry() {
	var _0_directory _dafny.Sequence
	_ = _0_directory
	var _out0 _dafny.Sequence
	_ = _out0
	...
	var _out1 m_Wrappers.Result
	_ = _out1
	_out1 = m_EsdkTestManifests.Companion_Default___.StartDecryptVectors(m_EsdkManifestOptions.Companion_ManifestOptions_.Create_Decrypt_(_dafny.Companion_Sequence_.Concatenate(_0_directory, _dafny.SeqOfString("dafny/TestVectors/test/invalid-Net-4.0.0/")), _dafny.SeqOfString("manifest.json"), m_AwsCryptographyEncryptionSdkTypes.Companion_NetV4__0__0__RetryPolicy_.Create_ALLOW__RETRY_(), m_Wrappers.Companion_Option_.Create_None_()))
	_1_result = _out1
	if (_1_result).Is_Failure() {
		_dafny.Print(((_1_result).Dtor_error().(_dafny.Sequence)).SetString())
	}
	if !((_1_result).Is_Success()) {
		panic("dafny/TestVectors/test/RunMain.dfy(81,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
}
func (_static *CompanionStruct_Default___) TestNet401ValidTestVectorsExpectSuccess() {
	var _0_directory _dafny.Sequence
	_ = _0_directory
	var _out0 _dafny.Sequence
	_ = _out0
	...
	var _out1 m_Wrappers.Result
	_ = _out1
	_out1 = m_EsdkTestManifests.Companion_Default___.StartDecryptVectors(m_EsdkManifestOptions.Companion_ManifestOptions_.Create_Decrypt_(_dafny.Companion_Sequence_.Concatenate(_0_directory, _dafny.SeqOfString("dafny/TestVectors/test/v4-Net-4.0.1/")), _dafny.SeqOfString("manifest.json"), m_AwsCryptographyEncryptionSdkTypes.Companion_NetV4__0__0__RetryPolicy_.Create_FORBID__RETRY_(), m_Wrappers.Companion_Option_.Create_None_()))
	_1_result = _out1
	if (_1_result).Is_Failure() {
		_dafny.Print(((_1_result).Dtor_error().(_dafny.Sequence)).SetString())
	}
	if !((_1_result).Is_Success()) {
		panic("dafny/TestVectors/test/RunMain.dfy(96,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
}
func (_static *CompanionStruct_Default___) TestGenerateEncryptManifest() {
	...
	var _out1 m_Wrappers.Result
	_ = _out1
	_out1 = m_WriteVectors.Companion_Default___.WriteTestVectors(m_EsdkManifestOptions.Companion_ManifestOptions_.Create_EncryptManifest_(_dafny.Companion_Sequence_.Concatenate(_0_directory, _dafny.SeqOfString("dafny/TestVectors/test/")), _dafny.IntOfInt64(5)))
	_1_result = _out1
	if (_1_result).Is_Failure() {
		_dafny.Print(((_1_result).Dtor_error().(_dafny.Sequence)).SetString())
	}
	if !((_1_result).Is_Success()) {
		panic("dafny/TestVectors/test/RunMain.dfy(109,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
}
...
func (_static *CompanionStruct_Default___) TestDecryptManifest() {
	...
	var _out1 m_Wrappers.Result
	_ = _out1
	_out1 = m_EsdkTestManifests.Companion_Default___.StartDecryptVectors(m_EsdkManifestOptions.Companion_ManifestOptions_.Create_Decrypt_(_dafny.Companion_Sequence_.Concatenate(_0_directory, _dafny.SeqOfString("dafny/TestVectors/test/")), _dafny.SeqOfString("decrypt-manifest.json"), m_AwsCryptographyEncryptionSdkTypes.Companion_NetV4__0__0__RetryPolicy_.Create_FORBID__RETRY_(), m_Wrappers.Companion_Option_.Create_None_()))
	_1_result = _out1
	if (_1_result).Is_Failure() {
		_dafny.Print(((_1_result).Dtor_error().(_dafny.Sequence)).SetString())
	}
	if !((_1_result).Is_Success()) {
		panic("dafny/TestVectors/test/RunMain.dfy(141,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
}
