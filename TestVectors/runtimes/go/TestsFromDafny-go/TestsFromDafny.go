...
import (
	...
	m_TestWrappedESDKMain "github.com/aws/aws-encryption-sdk/testvectors/test/TestWrappedESDKMain"
...
func (_static *CompanionStruct_Default___) Test____Main____(__noArgsParameter _dafny.Sequence) {
	...
	_ = _0_success
	_0_success = true
	_dafny.Print((_dafny.SeqOfString("TestWrappedESDKMain.RunManifestTests: ")).SetString())
	func() {
		defer func() {
			if r := recover(); r != nil {
		...
		{
			m_TestWrappedESDKMain.Companion_Default___.RunManifestTests()
			{
				_dafny.Print((_dafny.SeqOfString("PASSED\n")).SetString())
			}
		}
	}()
	_dafny.Print((_dafny.SeqOfString("TestWrappedESDKMain.TestNetRetryFlagVectorsExpectSuccess: ")).SetString())
	func() {
		defer func() {
			if r := recover(); r != nil {
		...
		{
			m_TestWrappedESDKMain.Companion_Default___.TestNetRetryFlagVectorsExpectSuccess()
			{
				_dafny.Print((_dafny.SeqOfString("PASSED\n")).SetString())
			}
		}
	}()
	_dafny.Print((_dafny.SeqOfString("TestWrappedESDKMain.TestNetInvalidTestVectorsExpectFailure: ")).SetString())
	func() {
		defer func() {
			if r := recover(); r != nil {
		...
		{
			m_TestWrappedESDKMain.Companion_Default___.TestNetInvalidTestVectorsExpectFailure()
			{
				_dafny.Print((_dafny.SeqOfString("PASSED\n")).SetString())
			}
		}
	}()
	_dafny.Print((_dafny.SeqOfString("TestWrappedESDKMain.TestNetInvalidTestVectorsExpectSuccessOnRetry: ")).SetString())
	func() {
		defer func() {
			if r := recover(); r != nil {
		...
		{
			m_TestWrappedESDKMain.Companion_Default___.TestNetInvalidTestVectorsExpectSuccessOnRetry()
			{
				_dafny.Print((_dafny.SeqOfString("PASSED\n")).SetString())
			}
		}
	}()
	_dafny.Print((_dafny.SeqOfString("TestWrappedESDKMain.TestNet401ValidTestVectorsExpectSuccess: ")).SetString())
	func() {
		defer func() {
			if r := recover(); r != nil {
		...
		{
			m_TestWrappedESDKMain.Companion_Default___.TestNet401ValidTestVectorsExpectSuccess()
			{
				_dafny.Print((_dafny.SeqOfString("PASSED\n")).SetString())
			}
		}
