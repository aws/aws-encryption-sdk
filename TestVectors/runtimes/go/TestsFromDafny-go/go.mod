...
replace (
	...
	github.com/aws/aws-cryptographic-material-providers-library/releases/go/mpl v0.0.0 => ../../../../mpl/AwsCryptographicMaterialProviders/runtimes/go/ImplementationFromDafny-go/
	...
	github.com/aws/aws-cryptographic-material-providers-library/releases/go/smithy-dafny-standard-library v0.0.0 => ../../../../mpl/StandardLibrary/runtimes/go/ImplementationFromDafny-go/
	...
	github.com/aws/aws-encryption-sdk-dafny/releases/go/encryption-sdk v0.0.0 => ../../../../AwsEncryptionSDK/runtimes/go/ImplementationFromDafny-go/
	github.com/aws/aws-encryption-sdk-dafny/releases/go/encryption-sdk/test v0.0.0 => ../../../../AwsEncryptionSDK/runtimes/go/TestsFromDafny-go/
	github.com/aws/aws-encryption-sdk/testvectors v0.0.0 => ../ImplementationFromDafny-go/
)
...
require (
	...
	github.com/aws/aws-encryption-sdk-dafny/releases/go/encryption-sdk v0.0.0
	github.com/aws/aws-encryption-sdk/testvectors v0.0.0
	github.com/dafny-lang/DafnyRuntimeGo/v4 v4.9.2
)

require (
	github.com/aws/aws-encryption-sdk-dafny/releases/go/encryption-sdk/test v0.0.0 // indirect
