...
func (_static *CompanionStruct_Default___) WriteDecryptManifest(op m_EsdkManifestOptions.ManifestOptions, keys *m_KeyVectors.KeyVectorsClient, tests _dafny.Sequence) m_Wrappers.Result {
	...
	_ = _5_manifestJson
	_5_manifestJson = m_JSON_Values.Companion_JSON_.Create_Object_(_dafny.SeqOf(_dafny.TupleOf(_dafny.SeqOfString("type"), m_JSON_Values.Companion_JSON_.Create_String_(_dafny.SeqOfString("awses-decrypt"))), _dafny.TupleOf(_dafny.SeqOfString("version"), m_JSON_Values.Companion_JSON_.Create_Number_(m_JSON_Values.Companion_Default___.Int(_dafny.IntOfInt64(3))))))
	var _6_esdkDecryptManifest m_JSON_Values.JSON
	_ = _6_esdkDecryptManifest
	_6_esdkDecryptManifest = m_JSON_Values.Companion_JSON_.Create_Object_(_dafny.SeqOf(_dafny.TupleOf(_dafny.SeqOfString("manifest"), _5_manifestJson), _dafny.TupleOf(_dafny.SeqOfString("client"), m_JSON_Values.Companion_JSON_.Create_String_(_dafny.SeqOfString("aws-encryption-sdk-dafny"))), _dafny.TupleOf(_dafny.SeqOfString("keys"), m_JSON_Values.Companion_JSON_.Create_String_(_dafny.SeqOfString("file://keys.json"))), _dafny.TupleOf(_dafny.SeqOfString("tests"), m_JSON_Values.Companion_JSON_.Create_Object_(_0_testsJSON))))
	var _7_valueOrError1 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(_dafny.EmptySeq)
	_ = _7_valueOrError1
	_7_valueOrError1 = m_JSON_API.Companion_Default___.Serialize(_6_esdkDecryptManifest)
	if !(!((_7_valueOrError1).IsFailure())) {
		panic("dafny/TestVectors/src/WriteVectors.dfy(146,36): " + (_7_valueOrError1).String())
	}
	var _8_esdkDecryptManifestBytes _dafny.Sequence
	_ = _8_esdkDecryptManifestBytes
	_8_esdkDecryptManifestBytes = (_7_valueOrError1).Extract().(_dafny.Sequence)
	var _9_esdkDecryptManifestBv _dafny.Sequence
	_ = _9_esdkDecryptManifestBv
	_9_esdkDecryptManifestBv = m_JSONHelpers.Companion_Default___.BytesBv(_8_esdkDecryptManifestBytes)
	var _10_valueOrError2 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(_dafny.TupleOf())
	_ = _10_valueOrError2
	var _out0 m_Wrappers.Result
	_ = _out0
	_out0 = m_FileIO.Companion_Default___.WriteBytesToFile(_dafny.Companion_Sequence_.Concatenate((op).Dtor_decryptManifestOutput(), _dafny.SeqOfString("decrypt-manifest.json")), _9_esdkDecryptManifestBv)
	_10_valueOrError2 = _out0
	if !(!((_10_valueOrError2).IsFailure())) {
		panic("dafny/TestVectors/src/WriteVectors.dfy(149,13): " + (_10_valueOrError2).String())
	}
	var _11___v3 _dafny.Tuple
	_ = _11___v3
	_11___v3 = (_10_valueOrError2).Extract().(_dafny.Tuple)
	output = m_Wrappers.Companion_Result_.Create_Success_(_dafny.TupleOf())
	return output
}
