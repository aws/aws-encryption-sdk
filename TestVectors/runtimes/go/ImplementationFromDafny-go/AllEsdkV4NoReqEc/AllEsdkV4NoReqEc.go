// Package AllEsdkV4NoReqEc
// Dafny module AllEsdkV4NoReqEc compiled into Go
...
func (*Default__) String() string {
	return "AllEsdkV4NoReqEc.Default__"
}
...
func (_static *CompanionStruct_Default___) AllPositiveKeyringTestsNoReqCmmNoKmsRsa() _dafny.Set {
	return ((((((((((_dafny.SetOf()).Union(m_AllDefaultCmm.Companion_Default___.SuccessTestingRequiredEncryptionContextKeysReproducedEncryptionContext())).Union(m_AllHierarchy.Companion_Default___.Tests())).Union(m_AllKms.Companion_Default___.Tests())).Union(m_AllKmsMrkAware.Companion_Default___.Tests())).Union(m_AllKmsMrkAwareDiscovery.Companion_Default___.Tests())).Union(m_AllRawAES.Companion_Default___.Tests())).Union(m_AllRawRSA.Companion_Default___.Tests())).Union(m_AllMulti.Companion_Default___.Tests())).Union(m_AllRawECDH.Companion_Default___.Tests())).Union(m_AllKmsEcdh.Companion_Default___.Tests())
}
func (_static *CompanionStruct_Default___) FrameSize() int64 {
	return int64(512)
}
func (_static *CompanionStruct_Default___) AllPostiveKeyringTestsNoDBESuiteNoReqEC() _dafny.Set {
	return func() _dafny.Set {
		var _coll0 = _dafny.NewBuilder()
		_ = _coll0
		for _iter0 := _dafny.Iterate((Companion_Default___.AllPositiveKeyringTestsNoReqCmmNoKmsRsa()).Elements()); ; {
			_compr_0, _ok0 := _iter0()
			if !_ok0 {
				break
			}
			var _0_keyringConfig m_TestVectors.EncryptTestVector
			_0_keyringConfig = interface{}(_compr_0).(m_TestVectors.EncryptTestVector)
			if ((Companion_Default___.AllPositiveKeyringTestsNoReqCmmNoKmsRsa()).Contains(_0_keyringConfig)) && (!((_0_keyringConfig).Is_NegativeEncryptKeyringVector())) {
				for _iter1 := _dafny.Iterate((m_AllAlgorithmSuites.Companion_Default___.ESDKAlgorithmSuites()).Elements()); ; {
...
func (_static *CompanionStruct_Default___) AwsKmsRsaTests() _dafny.Set {
	return m_AllKmsRsa.Companion_Default___.Tests()
}
func (_static *CompanionStruct_Default___) EsdkAlgorithmSuitesKmsRsa() _dafny.Set {
	return func() _dafny.Set {
		var _coll0 = _dafny.NewBuilder()
		_ = _coll0
		for _iter2 := _dafny.Iterate((m_AllAlgorithmSuites.Companion_Default___.AllAlgorithmSuites()).Elements()); ; {
			_compr_0, _ok2 := _iter2()
			if !_ok2 {
				break
			}
			var _0_suite m_AwsCryptographyMaterialProvidersTypes.AlgorithmSuiteInfo
			_0_suite = interface{}(_compr_0).(m_AwsCryptographyMaterialProvidersTypes.AlgorithmSuiteInfo)
			if m_AlgorithmSuites.Companion_AlgorithmSuite_.Is_(_0_suite) {
				if (((m_AllAlgorithmSuites.Companion_Default___.AllAlgorithmSuites()).Contains(_0_suite)) && (!(((_0_suite).Dtor_signature()).Is_ECDSA()))) && (((_0_suite).Dtor_id()).Is_ESDK()) {
					_coll0.Add(_0_suite)
				}
			}
		}
...
func (_static *CompanionStruct_Default___) AllPositiveKeyringTestsNoDBEKmsRsa() _dafny.Set {
	return func() _dafny.Set {
		var _coll0 = _dafny.NewBuilder()
		_ = _coll0
		for _iter3 := _dafny.Iterate((Companion_Default___.AwsKmsRsaTests()).Elements()); ; {
			...
			var _0_keyringConfig m_TestVectors.EncryptTestVector
			_0_keyringConfig = interface{}(_compr_0).(m_TestVectors.EncryptTestVector)
			if ((Companion_Default___.AwsKmsRsaTests()).Contains(_0_keyringConfig)) && (!((_0_keyringConfig).Is_NegativeEncryptKeyringVector())) {
				for _iter4 := _dafny.Iterate((Companion_Default___.EsdkAlgorithmSuitesKmsRsa()).Elements()); ; {
					...
					var _1_algorithmSuite m_AwsCryptographyMaterialProvidersTypes.AlgorithmSuiteInfo
					_1_algorithmSuite = interface{}(_compr_1).(m_AwsCryptographyMaterialProvidersTypes.AlgorithmSuiteInfo)
					if (Companion_Default___.EsdkAlgorithmSuitesKmsRsa()).Contains(_1_algorithmSuite) {
						_coll0.Add(m_EsdkTestVectors.Companion_EsdkEncryptTestVector_.Create_PositiveEncryptTestVector_(m_Wrappers.Companion_Option_.Create_None_(), _dafny.IntOfInt64(4), _dafny.SeqOfString(""), _dafny.SeqOfString(""), _dafny.SeqOfString(""), (_0_keyringConfig).Dtor_encryptDescription(), (_0_keyringConfig).Dtor_decryptDescription(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_AwsCryptographyMaterialProvidersTypes.Companion_ESDKCommitmentPolicy_.Create_FORBID__ENCRYPT__ALLOW__DECRYPT_(), m_Wrappers.Companion_Option_.Create_Some_(Companion_Default___.FrameSize()), m_Wrappers.Companion_Option_.Create_Some_(_1_algorithmSuite), (_0_keyringConfig).Dtor_name(), m_Wrappers.Companion_Option_.Create_Some_(int64(1))))
					}
				}
			}
...
func (_static *CompanionStruct_Default___) Tests() _dafny.Set {
	return (Companion_Default___.AllPostiveKeyringTestsNoDBESuiteNoReqEC()).Union(Companion_Default___.AllPositiveKeyringTestsNoDBEKmsRsa())
}
