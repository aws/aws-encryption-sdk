...
func (_static *CompanionStruct_Default___) StartDecryptVectors(op m_EsdkManifestOptions.ManifestOptions) m_Wrappers.Result {
	...
	_ = _3_valueOrError2
	_3_valueOrError2 = m_ParseEsdkJsonManifest.Companion_Default___.BuildDecryptTestVector(op, (_1_decryptManifest).Dtor_clientName(), (_1_decryptManifest).Dtor_clientVersion(), (_1_decryptManifest).Dtor_version(), (_1_decryptManifest).Dtor_keys(), (_1_decryptManifest).Dtor_jsonTests())
...
func (_static *CompanionStruct_Default___) TestDecrypts(keys *m_KeyVectors.KeyVectorsClient, vectors _dafny.Sequence) m_Wrappers.Result {
	...
	if !(_0_hasFailure) {
		...
		manifest = m_Wrappers.Companion_Result_.Create_Failure_(_dafny.SeqOfString("Test Vectors failed, see errors above.\n"))
	}
	return manifest
}
...
func (_static *CompanionStruct_Default___) GetManifest(manifestPath _dafny.Sequence, manifestFileName _dafny.Sequence) m_Wrappers.Result {
	...
	_ = _13_valueOrError6
	_13_valueOrError6 = m_JSONHelpers.Companion_Default___.GetObject(_dafny.SeqOfString("client"), (_5_manifestJson).Dtor_obj())
	if (_13_valueOrError6).IsFailure() {
		manifestData = (_13_valueOrError6).PropagateFailure()
		return manifestData
	}
	var _14_client _dafny.Sequence
	_ = _14_client
	_14_client = (_13_valueOrError6).Extract().(_dafny.Sequence)
	var _15_valueOrError7 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(_dafny.EmptySeq.SetString())
	_ = _15_valueOrError7
	_15_valueOrError7 = m_JSONHelpers.Companion_Default___.GetString(_dafny.SeqOfString("name"), _14_client)
	if (_15_valueOrError7).IsFailure() {
		manifestData = (_15_valueOrError7).PropagateFailure()
		return manifestData
	}
	var _16_clientName _dafny.Sequence
	_ = _16_clientName
	_16_clientName = (_15_valueOrError7).Extract().(_dafny.Sequence)
	var _17_valueOrError8 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(_dafny.EmptySeq.SetString())
	_ = _17_valueOrError8
	_17_valueOrError8 = m_JSONHelpers.Companion_Default___.GetString(_dafny.SeqOfString("version"), _14_client)
	if (_17_valueOrError8).IsFailure() {
		manifestData = (_17_valueOrError8).PropagateFailure()
		return manifestData
	}
	var _18_clientVersion _dafny.Sequence
	_ = _18_clientVersion
	_18_clientVersion = (_17_valueOrError8).Extract().(_dafny.Sequence)
	var _19_valueOrError9 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(_dafny.EmptySeq.SetString())
	_ = _19_valueOrError9
	_19_valueOrError9 = m_JSONHelpers.Companion_Default___.GetString(_dafny.SeqOfString("keys"), (_5_manifestJson).Dtor_obj())
	if (_19_valueOrError9).IsFailure() {
		manifestData = (_19_valueOrError9).PropagateFailure()
		return manifestData
	}
	var _20_keyManifestUri _dafny.Sequence
	_ = _20_keyManifestUri
	_20_keyManifestUri = (_19_valueOrError9).Extract().(_dafny.Sequence)
	var _21_valueOrError10 m_Wrappers.Outcome = m_Wrappers.Companion_Outcome_.Default()
	_ = _21_valueOrError10
	_21_valueOrError10 = m_Wrappers.Companion_Default___.Need(_dafny.Companion_Sequence_.IsProperPrefixOf(_dafny.SeqOfString("file://"), _20_keyManifestUri), _dafny.SeqOfString("Unexpected URI prefix"))
	if (_21_valueOrError10).IsFailure() {
		manifestData = (_21_valueOrError10).PropagateFailure()
		return manifestData
	}
	var _22_keyManifestPath _dafny.Sequence
	_ = _22_keyManifestPath
	_22_keyManifestPath = _dafny.Companion_Sequence_.Concatenate(manifestPath, (_20_keyManifestUri).Drop(7))
	var _23_valueOrError11 m_Wrappers.Result = m_Wrappers.Result{}
	_ = _23_valueOrError11
	var _out1 m_Wrappers.Result
	_ = _out1
	_out1 = m_KeyVectors.Companion_Default___.KeyVectors(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Companion_KeyVectorsConfig_.Create_KeyVectorsConfig_(_22_keyManifestPath))
	_23_valueOrError11 = _out1
	if !(!((_23_valueOrError11).IsFailure())) {
		panic("dafny/TestVectors/src/EsdkTestManifests.dfy(268,16): " + (_23_valueOrError11).String())
	}
	var _24_keys *m_KeyVectors.KeyVectorsClient
	_ = _24_keys
	_24_keys = (_23_valueOrError11).Extract().(*m_KeyVectors.KeyVectorsClient)
	var _25_valueOrError12 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(_dafny.EmptySeq)
	_ = _25_valueOrError12
	_25_valueOrError12 = m_JSONHelpers.Companion_Default___.GetObject(_dafny.SeqOfString("tests"), (_5_manifestJson).Dtor_obj())
	if (_25_valueOrError12).IsFailure() {
		manifestData = (_25_valueOrError12).PropagateFailure()
		return manifestData
	}
	var _26_jsonTests _dafny.Sequence
	_ = _26_jsonTests
	_26_jsonTests = (_25_valueOrError12).Extract().(_dafny.Sequence)
	var _source0 _dafny.Sequence = _12_typ
	_ = _source0
	{
		{
			if (_source0).Equals(_dafny.SeqOfString("awses-decrypt")) {
				var _27_valueOrError13 m_Wrappers.Outcome = m_Wrappers.Companion_Outcome_.Default()
				_ = _27_valueOrError13
				_27_valueOrError13 = m_Wrappers.Companion_Default___.Need(m_EsdkTestVectors.Companion_Default___.SupportedDecryptVersion_q(_10_version), _dafny.SeqOfString("Unsupported manifest version"))
				if (_27_valueOrError13).IsFailure() {
					manifestData = (_27_valueOrError13).PropagateFailure()
					return manifestData
				}
				manifestData = m_Wrappers.Companion_Result_.Create_Success_(Companion_ManifestData_.Create_DecryptManifest_(_10_version, _24_keys, _16_clientName, _18_clientVersion, _26_jsonTests))
				goto Lmatch0
			}
		}
		{
			if (_source0).Equals(_dafny.SeqOfString("awses-encrypt")) {
				var _28_valueOrError14 m_Wrappers.Outcome = m_Wrappers.Companion_Outcome_.Default()
				_ = _28_valueOrError14
				_28_valueOrError14 = m_Wrappers.Companion_Default___.Need(m_EsdkTestVectors.Companion_Default___.SupportedEncryptVersion_q(_10_version), _dafny.SeqOfString("Unsupported manifest version"))
				if (_28_valueOrError14).IsFailure() {
					manifestData = (_28_valueOrError14).PropagateFailure()
					return manifestData
				}
				var _29_valueOrError15 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(_dafny.EmptySeq)
				_ = _29_valueOrError15
				_29_valueOrError15 = m_JSONHelpers.Companion_Default___.GetObject(_dafny.SeqOfString("plaintexts"), (_5_manifestJson).Dtor_obj())
				if (_29_valueOrError15).IsFailure() {
					manifestData = (_29_valueOrError15).PropagateFailure()
					return manifestData
				}
				var _30_plaintextsJson _dafny.Sequence
				_ = _30_plaintextsJson
				_30_plaintextsJson = (_29_valueOrError15).Extract().(_dafny.Sequence)
				var _31_valueOrError17 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(_dafny.EmptySeq)
				_ = _31_valueOrError17
				_31_valueOrError17 = m_Seq.Companion_Default___.MapWithResult(func(coer10 func(_dafny.Tuple) m_Wrappers.Result) func(interface{}) m_Wrappers.Result {
					return func(arg12 interface{}) m_Wrappers.Result {
						return coer10(arg12.(_dafny.Tuple))
					}
				}(func(_32_obj _dafny.Tuple) m_Wrappers.Result {
					return func(_pat_let7_0 m_Wrappers.Outcome) m_Wrappers.Result {
						return func(_33_valueOrError16 m_Wrappers.Outcome) m_Wrappers.Result {
							return (func() m_Wrappers.Result {
								if (_33_valueOrError16).IsFailure() {
									return (_33_valueOrError16).PropagateFailure()
								}
								return m_Wrappers.Companion_Result_.Create_Success_(_dafny.TupleOf((*(_32_obj).IndexInt(0)).(_dafny.Sequence), ((((*(_32_obj).IndexInt(1)).(m_JSON_Values.JSON)).Dtor_num()).Dtor_n()).Int32()))
							})()
						}(_pat_let7_0)
					}(m_Wrappers.Companion_Default___.Need((((*(_32_obj).IndexInt(1)).(m_JSON_Values.JSON)).Is_Number()) && ((((((*(_32_obj).IndexInt(1)).(m_JSON_Values.JSON)).Dtor_num()).Dtor_n()).Sign() == 1) && (((((*(_32_obj).IndexInt(1)).(m_JSON_Values.JSON)).Dtor_num()).Dtor_n()).Cmp(_dafny.IntOfInt32(m_BoundedInts.Companion_Default___.INT32__MAX())) <= 0)), _dafny.SeqOfString("Size is not a natural number.")))
				}), _30_plaintextsJson)
				if (_31_valueOrError17).IsFailure() {
					manifestData = (_31_valueOrError17).PropagateFailure()
					return manifestData
				}
				var _34_plaintextsLength _dafny.Sequence
				_ = _34_plaintextsLength
				_34_plaintextsLength = (_31_valueOrError17).Extract().(_dafny.Sequence)
				manifestData = m_Wrappers.Companion_Result_.Create_Success_(Companion_ManifestData_.Create_EncryptManifest_(_10_version, _24_keys, _34_plaintextsLength, _26_jsonTests))
				goto Lmatch0
			}
		}
		{
...
type ManifestData_DecryptManifest struct {
	...
	ClientName    _dafny.Sequence
	ClientVersion _dafny.Sequence
	JsonTests     _dafny.Sequence
}

func (ManifestData_DecryptManifest) isManifestData() {}

func (CompanionStruct_ManifestData_) Create_DecryptManifest_(Version _dafny.Int, Keys *m_KeyVectors.KeyVectorsClient, ClientName _dafny.Sequence, ClientVersion _dafny.Sequence, JsonTests _dafny.Sequence) ManifestData {
	return ManifestData{ManifestData_DecryptManifest{Version, Keys, ClientName, ClientVersion, JsonTests}}
}
...
func (CompanionStruct_ManifestData_) Default() ManifestData {
	return Companion_ManifestData_.Create_DecryptManifest_(_dafny.Zero, (*m_KeyVectors.KeyVectorsClient)(nil), _dafny.EmptySeq.SetString(), _dafny.EmptySeq.SetString(), _dafny.EmptySeq)
}
...
func (_this ManifestData) Dtor_clientName() _dafny.Sequence {
	return _this.Get_().(ManifestData_DecryptManifest).ClientName
}

func (_this ManifestData) Dtor_clientVersion() _dafny.Sequence {
	return _this.Get_().(ManifestData_DecryptManifest).ClientVersion
}
...
func (_this ManifestData) String() string {
	...
	case ManifestData_DecryptManifest:
		{
			return "EsdkTestManifests.ManifestData.DecryptManifest" + "(" + _dafny.String(data.Version) + ", " + _dafny.String(data.Keys) + ", " + _dafny.String(data.ClientName) + ", " + _dafny.String(data.ClientVersion) + ", " + _dafny.String(data.JsonTests) + ")"
		}
	...
	case ManifestData_DecryptManifest:
		{
			...
			return ok && data1.Version.Cmp(data2.Version) == 0 && data1.Keys == data2.Keys && data1.ClientName.Equals(data2.ClientName) && data1.ClientVersion.Equals(data2.ClientVersion) && data1.JsonTests.Equals(data2.JsonTests)
		}
	case ManifestData_EncryptManifest:
		{
