// Package WriteEsdkJsonManifests
// Dafny module WriteEsdkJsonManifests compiled into Go
...
func (*Default__) String() string {
	return "WriteEsdkJsonManifests.Default__"
}
...
func (_static *CompanionStruct_Default___) EncryptionContextKeysToJson(keys m_Wrappers.Option) m_Wrappers.Result {
	if (keys).Is_Some() {
		var _0_valueOrError0 m_Wrappers.Result = m_Seq.Companion_Default___.MapWithResult(func(coer2 func(_dafny.Sequence) m_Wrappers.Result) func(interface{}) m_Wrappers.Result {
			return func(arg2 interface{}) m_Wrappers.Result {
			...
			return func(_pat_let0_0 m_Wrappers.Result) m_Wrappers.Result {
				return func(_2_valueOrError1 m_Wrappers.Result) m_Wrappers.Result {
					return (func() m_Wrappers.Result {
						...
						return func(_pat_let1_0 _dafny.Sequence) m_Wrappers.Result {
...
func (_static *CompanionStruct_Default___) EncryptionContextToJson(key _dafny.Sequence, m _dafny.Map) m_Wrappers.Result {
	var _0_keys _dafny.Sequence = m_SortedSets.SetToOrderedSequence2((m).Keys(), func(coer3 func(uint8, uint8) bool) func(interface{}, interface{}) bool {
		return func(arg3 interface{}, arg4 interface{}) bool {
			return coer3(arg3.(uint8), arg4.(uint8))
		}
	}(func(_1_a uint8, _2_b uint8) bool {
		return (_1_a) < (_2_b)
	}))
	_ = _0_keys
	var _3_valueOrError0 m_Wrappers.Result = m_Seq.Companion_Default___.MapWithResult(func(coer4 func(_dafny.Sequence) m_Wrappers.Result) func(interface{}) m_Wrappers.Result {
		return func(arg5 interface{}) m_Wrappers.Result {
			return coer4(arg5.(_dafny.Sequence))
		}
	}((func(_4_m _dafny.Map) func(_dafny.Sequence) m_Wrappers.Result {
		return func(_5_k _dafny.Sequence) m_Wrappers.Result {
			return func(_pat_let2_0 m_Wrappers.Result) m_Wrappers.Result {
				return func(_6_valueOrError1 m_Wrappers.Result) m_Wrappers.Result {
					return (func() m_Wrappers.Result {
						if (_6_valueOrError1).IsFailure() {
							return (_6_valueOrError1).PropagateFailure()
						}
						return func(_pat_let3_0 _dafny.Sequence) m_Wrappers.Result {
							return func(_7_key _dafny.Sequence) m_Wrappers.Result {
								return func(_pat_let4_0 m_Wrappers.Result) m_Wrappers.Result {
									return func(_8_valueOrError2 m_Wrappers.Result) m_Wrappers.Result {
										return (func() m_Wrappers.Result {
											...
											return func(_pat_let5_0 _dafny.Sequence) m_Wrappers.Result {
												return func(_9_value _dafny.Sequence) m_Wrappers.Result {
													return m_Wrappers.Companion_Result_.Create_Success_(_dafny.TupleOf(_7_key, m_JSON_Values.Companion_JSON_.Create_String_(_9_value)))
												}(_pat_let5_0)
											}((_8_valueOrError2).Extract().(_dafny.Sequence))
										})()
									}(_pat_let4_0)
								}(m_UTF8.Decode((_4_m).Get(_5_k).(_dafny.Sequence)))
							}(_pat_let3_0)
						}((_6_valueOrError1).Extract().(_dafny.Sequence))
					})()
				}(_pat_let2_0)
			}(m_UTF8.Decode(_5_k))
		}
	...
	if (_3_valueOrError0).IsFailure() {
		...
		var _10_pairsBytes _dafny.Sequence = (_3_valueOrError0).Extract().(_dafny.Sequence)
		_ = _10_pairsBytes
		return m_Wrappers.Companion_Result_.Create_Success_(_dafny.SeqOf(_dafny.TupleOf(key, m_JSON_Values.Companion_JSON_.Create_Object_(_10_pairsBytes))))
	}
}
...
func (_static *CompanionStruct_Default___) EncryptTestVectorToJson(test m_EsdkTestVectors.EsdkEncryptTestVector) m_Wrappers.Result {
	var _0_valueOrError0 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need((((test).Dtor_algorithmSuiteId()).Is_Some()) && (((test).Dtor_frameLength()).Is_Some()), _dafny.SeqOfString("test is missing algorithmSuite ID, or frameLength"))
	_ = _0_valueOrError0
	if (_0_valueOrError0).IsFailure() {
		return (_0_valueOrError0).PropagateFailure()
	} else {
		var _1_id _dafny.Sequence = m_AllAlgorithmSuites.Companion_Default___.ToHex(((test).Dtor_algorithmSuiteId()).Dtor_value().(m_AwsCryptographyMaterialProvidersTypes.AlgorithmSuiteInfo))
		_ = _1_id
		var _2_valueOrError1 m_Wrappers.Result = (func() m_Wrappers.Result {
			if ((test).Dtor_encryptionContext()).Is_Some() {
				return Companion_Default___.EncryptionContextToJson(_dafny.SeqOfString("encryption-context"), ((test).Dtor_encryptionContext()).Dtor_value().(_dafny.Map))
			}
			return Companion_Default___.EncryptionContextToJson(_dafny.SeqOfString("encryption-context"), _dafny.NewMapBuilder().ToMap())
		})()
		_ = _2_valueOrError1
		if (_2_valueOrError1).IsFailure() {
			return (_2_valueOrError1).PropagateFailure()
		} else {
			var _3_encryptionContext _dafny.Sequence = (_2_valueOrError1).Extract().(_dafny.Sequence)
			_ = _3_encryptionContext
			var _4_valueOrError2 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need((_dafny.IntOfUint32((_3_encryptionContext).Cardinality())).Cmp(_dafny.One) == 0, _dafny.SeqOfString("Error parsing encryption context"))
			_ = _4_valueOrError2
			if (_4_valueOrError2).IsFailure() {
				return (_4_valueOrError2).PropagateFailure()
			} else {
				var _5_valueOrError3 m_Wrappers.Result = (func() m_Wrappers.Result {
					if ((test).Dtor_reproducedEncryptionContext()).Is_Some() {
						return Companion_Default___.EncryptionContextToJson(_dafny.SeqOfString("reproduced-encryption-context"), ((test).Dtor_reproducedEncryptionContext()).Dtor_value().(_dafny.Map))
					}
					return Companion_Default___.EncryptionContextToJson(_dafny.SeqOfString("reproduced-encryption-context"), _dafny.NewMapBuilder().ToMap())
				})()
				_ = _5_valueOrError3
				if (_5_valueOrError3).IsFailure() {
					return (_5_valueOrError3).PropagateFailure()
				} else {
					var _6_reproducedEncryptionContext _dafny.Sequence = (_5_valueOrError3).Extract().(_dafny.Sequence)
					_ = _6_reproducedEncryptionContext
					var _7_optionalValues _dafny.Sequence = _dafny.Companion_Sequence_.Concatenate(_3_encryptionContext, _6_reproducedEncryptionContext)
					_ = _7_optionalValues
					var _source0 m_EsdkTestVectors.EsdkEncryptTestVector = test
					_ = _source0
					{
						if _source0.Is_PositiveEncryptTestVector() {
							var _8_valueOrError4 m_Wrappers.Result = m_KeyDescription.Companion_Default___.ToJson((test).Dtor_encryptDescriptions(), _dafny.IntOfInt64(3))
							_ = _8_valueOrError4
							if (_8_valueOrError4).IsFailure() {
								return (_8_valueOrError4).PropagateFailure()
							} else {
								var _9_encrypt m_JSON_Values.JSON = (_8_valueOrError4).Extract().(m_JSON_Values.JSON)
								_ = _9_encrypt
								var _10_valueOrError5 m_Wrappers.Result = m_KeyDescription.Companion_Default___.ToJson((test).Dtor_decryptDescriptions(), _dafny.IntOfInt64(3))
								_ = _10_valueOrError5
								if (_10_valueOrError5).IsFailure() {
									return (_10_valueOrError5).PropagateFailure()
								} else {
									var _11_decrypt m_JSON_Values.JSON = (_10_valueOrError5).Extract().(m_JSON_Values.JSON)
									_ = _11_decrypt
									var _12_scenario m_JSON_Values.JSON = m_JSON_Values.Companion_JSON_.Create_Object_(_dafny.Companion_Sequence_.Concatenate(_dafny.SeqOf(_dafny.TupleOf(_dafny.SeqOfString("type"), m_JSON_Values.Companion_JSON_.Create_String_(_dafny.SeqOfString("positive-esdk"))), _dafny.TupleOf(_dafny.SeqOfString("plaintext"), m_JSON_Values.Companion_JSON_.Create_String_(_dafny.SeqOfString("small"))), _dafny.TupleOf(_dafny.SeqOfString("description"), m_JSON_Values.Companion_JSON_.Create_String_((test).Dtor_description())), _dafny.TupleOf(_dafny.SeqOfString("algorithmSuiteId"), m_JSON_Values.Companion_JSON_.Create_String_(_1_id)), _dafny.TupleOf(_dafny.SeqOfString("frame-size"), m_JSON_Values.Companion_JSON_.Create_Number_(m_JSON_Values.Companion_Default___.Int(_dafny.IntOfInt64(((test).Dtor_frameLength()).Dtor_value().(int64))))), _dafny.TupleOf(_dafny.SeqOfString("encryptKeyDescription"), _9_encrypt), _dafny.TupleOf(_dafny.SeqOfString("decryptKeyDescription"), _11_decrypt)), _7_optionalValues))
									_ = _12_scenario
									return m_Wrappers.Companion_Result_.Create_Success_(m_JSON_Values.Companion_JSON_.Create_Object_(_dafny.SeqOf(_dafny.TupleOf(_dafny.SeqOfString("encryption-scenario"), _12_scenario))))
								}
							}
						}
					}
					{
						return m_Wrappers.Companion_Result_.Create_Failure_(_dafny.SeqOfString("Only Positive Tests supported :("))
					}
				}
			}
		}
...
func (_static *CompanionStruct_Default___) DecryptTestVectorToJson(test m_EsdkTestVectors.EsdkDecryptTestVector) m_Wrappers.Result {
	var _0_valueOrError0 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need((((test).Dtor_algorithmSuiteId()).Is_Some()) && (((test).Dtor_frameLength()).Is_Some()), _dafny.SeqOfString("test is missing algorithmSuite ID, or frameLength"))
	_ = _0_valueOrError0
	if (_0_valueOrError0).IsFailure() {
		return (_0_valueOrError0).PropagateFailure()
		...
		var _1_id _dafny.Sequence = m_AllAlgorithmSuites.Companion_Default___.ToHex(((test).Dtor_algorithmSuiteId()).Dtor_value().(m_AwsCryptographyMaterialProvidersTypes.AlgorithmSuiteInfo))
		_ = _1_id
		var _2_description _dafny.Sequence = _dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate((test).Dtor_description(), _dafny.SeqOfString(" ")), _1_id)
		_ = _2_description
		var _3_valueOrError1 m_Wrappers.Result = (func() m_Wrappers.Result {
			if ((test).Dtor_reproducedEncryptionContext()).Is_Some() {
				return Companion_Default___.EncryptionContextToJson(_dafny.SeqOfString("reproduced-encryption-context"), ((test).Dtor_reproducedEncryptionContext()).Dtor_value().(_dafny.Map))
			}
			return Companion_Default___.EncryptionContextToJson(_dafny.SeqOfString("reproduced-encryption-context"), _dafny.NewMapBuilder().ToMap())
		...
		if (_3_valueOrError1).IsFailure() {
			...
			var _4_reproducedEncryptionContext _dafny.Sequence = (_3_valueOrError1).Extract().(_dafny.Sequence)
			_ = _4_reproducedEncryptionContext
			var _5_valueOrError2 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need((_dafny.IntOfUint32((_4_reproducedEncryptionContext).Cardinality())).Cmp(_dafny.One) == 0, _dafny.SeqOfString("Error parsing encryption context"))
			_ = _5_valueOrError2
			if (_5_valueOrError2).IsFailure() {
				return (_5_valueOrError2).PropagateFailure()
			} else {
				var _6_optionalValues _dafny.Sequence = _4_reproducedEncryptionContext
				_ = _6_optionalValues
				var _source0 m_EsdkTestVectors.EsdkDecryptTestVector = test
				_ = _source0
				{
					if _source0.Is_PositiveDecryptTestVector() {
						var _7_valueOrError3 m_Wrappers.Result = m_KeyDescription.Companion_Default___.ToJson((test).Dtor_decryptDescriptions(), _dafny.IntOfInt64(3))
						_ = _7_valueOrError3
						if (_7_valueOrError3).IsFailure() {
							return (_7_valueOrError3).PropagateFailure()
						} else {
							var _8_decrypt m_JSON_Values.JSON = (_7_valueOrError3).Extract().(m_JSON_Values.JSON)
							_ = _8_decrypt
							var _9_scenario m_JSON_Values.JSON = m_JSON_Values.Companion_JSON_.Create_Object_(_dafny.Companion_Sequence_.Concatenate(_dafny.SeqOf(_dafny.TupleOf(_dafny.SeqOfString("type"), m_JSON_Values.Companion_JSON_.Create_String_(_dafny.SeqOfString("positive-esdk"))), _dafny.TupleOf(_dafny.SeqOfString("ciphertext"), m_JSON_Values.Companion_JSON_.Create_String_(_dafny.Companion_Sequence_.Concatenate(_dafny.SeqOfString("file://ciphertexts/"), (test).Dtor_id()))), _dafny.TupleOf(_dafny.SeqOfString("result"), m_JSON_Values.Companion_JSON_.Create_String_(_dafny.Companion_Sequence_.Concatenate(_dafny.SeqOfString("file://"), (test).Dtor_plaintextPath()))), _dafny.TupleOf(_dafny.SeqOfString("algorithmSuiteId"), m_JSON_Values.Companion_JSON_.Create_String_(_1_id)), _dafny.TupleOf(_dafny.SeqOfString("frame-size"), m_JSON_Values.Companion_JSON_.Create_Number_(m_JSON_Values.Companion_Default___.Int(_dafny.IntOfInt64(((test).Dtor_frameLength()).Dtor_value().(int64))))), _dafny.TupleOf(_dafny.SeqOfString("description"), m_JSON_Values.Companion_JSON_.Create_String_((test).Dtor_description())), _dafny.TupleOf(_dafny.SeqOfString("decryptKeyDescription"), _8_decrypt)), _6_optionalValues))
							_ = _9_scenario
							return m_Wrappers.Companion_Result_.Create_Success_(m_JSON_Values.Companion_JSON_.Create_Object_(_dafny.SeqOf(_dafny.TupleOf(_dafny.SeqOfString("decryption-scenario"), _9_scenario))))
						}
					}
				}
				{
