...
func (_static *CompanionStruct_Default___) BuildDecryptTestVector(op m_EsdkManifestOptions.ManifestOptions, clientName _dafny.Sequence, clientVersion _dafny.Sequence, version _dafny.Int, keys *m_KeyVectors.KeyVectorsClient, obj _dafny.Sequence) m_Wrappers.Result {
	...
	for (_0_i).Sign() != 0 {
		...
		_ = _2_test
		_2_test = Companion_Default___.ToDecryptTestVectors(op, clientName, clientVersion, version, keys, (*((obj).Select((_0_i).Uint32()).(_dafny.Tuple)).IndexInt(0)).(_dafny.Sequence), (*((obj).Select((_0_i).Uint32()).(_dafny.Tuple)).IndexInt(1)).(m_JSON_Values.JSON))
...
func (_static *CompanionStruct_Default___) ToDecryptTestVectors(op m_EsdkManifestOptions.ManifestOptions, clientName _dafny.Sequence, clientVersion _dafny.Sequence, version _dafny.Int, keys *m_KeyVectors.KeyVectorsClient, name _dafny.Sequence, json m_JSON_Values.JSON) m_Wrappers.Result {
	...
	if (_0_valueOrError0).IsFailure() {
		...
		_ = _source0
		{
			if (_source0).Cmp(_dafny.IntOfInt64(5)) == 0 {
				...
				if (_2_valueOrError1).IsFailure() {
					...
					return Companion_Default___.V5ToDecryptTestVector(op, keys, name, _1_obj, version)
				}
			}
		}
		{
			if (_source0).Cmp(_dafny.IntOfInt64(4)) == 0 {
				...
				if (_3_valueOrError2).IsFailure() {
					...
					var _4_valueOrError3 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need(_dafny.Companion_Sequence_.Equal(clientName, _dafny.SeqOfString("ESDK-NET")), _dafny.SeqOfString("Err; Version 4 manifest only supported for NET"))
					_ = _4_valueOrError3
					if (_4_valueOrError3).IsFailure() {
						return (_4_valueOrError3).PropagateFailure()
					} else {
						return Companion_Default___.V4ToDecryptTestVector(op, keys, name, _1_obj, version)
					}
				}
			}
		}
		{
			if (_source0).Cmp(_dafny.IntOfInt64(2)) == 0 {
				var _5_valueOrError4 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need((op).Is_Decrypt(), _dafny.SeqOfString("Err parsing manifest expected Decrypt"))
				_ = _5_valueOrError4
		...
		}
		{
			if (_source0).Cmp(_dafny.One) == 0 {
				var _6_valueOrError5 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need((op).Is_Decrypt(), _dafny.SeqOfString("Err parsing manifest expected Decrypt"))
				_ = _6_valueOrError5
...
func (_static *CompanionStruct_Default___) V5ToDecryptTestVector(op m_EsdkManifestOptions.ManifestOptions, keys *m_KeyVectors.KeyVectorsClient, name _dafny.Sequence, obj _dafny.Sequence, version _dafny.Int) m_Wrappers.Result {
...
func (_static *CompanionStruct_Default___) V4ToDecryptTestVector(op m_EsdkManifestOptions.ManifestOptions, keys *m_KeyVectors.KeyVectorsClient, name _dafny.Sequence, obj _dafny.Sequence, version _dafny.Int) m_Wrappers.Result {
	var _0_valueOrError0 m_Wrappers.Result = m_JSONHelpers.Companion_Default___.GetObject(_dafny.SeqOfString("result"), obj)
	_ = _0_valueOrError0
	if (_0_valueOrError0).IsFailure() {
		return (_0_valueOrError0).PropagateFailure()
		...
		var _1_resultLoc _dafny.Sequence = (_0_valueOrError0).Extract().(_dafny.Sequence)
		_ = _1_resultLoc
		var _2_valueOrError1 m_Wrappers.Result = m_JSONHelpers.Companion_Default___.GetObject(_dafny.SeqOfString("output"), _1_resultLoc)
		_ = _2_valueOrError1
		if (_2_valueOrError1).IsFailure() {
			return (_2_valueOrError1).PropagateFailure()
		} else {
			var _3_outputLoc _dafny.Sequence = (_2_valueOrError1).Extract().(_dafny.Sequence)
			_ = _3_outputLoc
			var _4_valueOrError2 m_Wrappers.Result = m_JSONHelpers.Companion_Default___.GetString(_dafny.SeqOfString("plaintext"), _3_outputLoc)
			_ = _4_valueOrError2
			if (_4_valueOrError2).IsFailure() {
				return (_4_valueOrError2).PropagateFailure()
			} else {
				var _5_plaintextLoc _dafny.Sequence = (_4_valueOrError2).Extract().(_dafny.Sequence)
				_ = _5_plaintextLoc
				var _6_valueOrError3 m_Wrappers.Result = m_JSONHelpers.Companion_Default___.GetString(_dafny.SeqOfString("ciphertext"), obj)
				_ = _6_valueOrError3
				if (_6_valueOrError3).IsFailure() {
					return (_6_valueOrError3).PropagateFailure()
				} else {
					var _7_ciphertextLoc _dafny.Sequence = (_6_valueOrError3).Extract().(_dafny.Sequence)
					_ = _7_ciphertextLoc
					var _8_valueOrError4 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need((_dafny.Companion_Sequence_.IsProperPrefixOf(_dafny.SeqOfString("file://"), _7_ciphertextLoc)) && (_dafny.Companion_Sequence_.IsProperPrefixOf(_dafny.SeqOfString("file://"), _5_plaintextLoc)), _dafny.SeqOfString("Invalid file prefix in test vector"))
					_ = _8_valueOrError4
					if (_8_valueOrError4).IsFailure() {
						return (_8_valueOrError4).PropagateFailure()
					} else {
						var _9_valueOrError5 m_Wrappers.Result = m_JSONHelpers.Companion_Default___.GetArray(_dafny.SeqOfString("master-keys"), obj)
						_ = _9_valueOrError5
						if (_9_valueOrError5).IsFailure() {
							return (_9_valueOrError5).PropagateFailure()
						} else {
							var _10_masterKeys _dafny.Sequence = (_9_valueOrError5).Extract().(_dafny.Sequence)
							_ = _10_masterKeys
							var _11_valueOrError6 m_Wrappers.Result = Companion_Default___.GetKeyDescriptions(_10_masterKeys, keys)
							_ = _11_valueOrError6
							if (_11_valueOrError6).IsFailure() {
								return (_11_valueOrError6).PropagateFailure()
							} else {
								var _12_keyDescriptions _dafny.Sequence = (_11_valueOrError6).Extract().(_dafny.Sequence)
								_ = _12_keyDescriptions
								var _13_valueOrError7 m_Wrappers.Result = Companion_Default___.ToMultiKeyDescription(_12_keyDescriptions)
								_ = _13_valueOrError7
								if (_13_valueOrError7).IsFailure() {
									return (_13_valueOrError7).PropagateFailure()
								} else {
									var _14_keyDescription m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription = (_13_valueOrError7).Extract().(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription)
									_ = _14_keyDescription
									var _15_valueOrError8 m_Wrappers.Result = m_JSONHelpers.Companion_Default___.GetString(_dafny.SeqOfString("cmm"), obj)
									_ = _15_valueOrError8
									if (_15_valueOrError8).IsFailure() {
										return (_15_valueOrError8).PropagateFailure()
									} else {
										var _16_cmm _dafny.Sequence = (_15_valueOrError8).Extract().(_dafny.Sequence)
										_ = _16_cmm
										var _17_valueOrError9 m_Wrappers.Result = m_JSONHelpers.Companion_Default___.SmallObjectToStringStringMap(_dafny.SeqOfString("encryption-context"), obj)
										_ = _17_valueOrError9
										if (_17_valueOrError9).IsFailure() {
											return (_17_valueOrError9).PropagateFailure()
										} else {
											var _18_encryptionContextStrings _dafny.Map = (_17_valueOrError9).Extract().(_dafny.Map)
											_ = _18_encryptionContextStrings
											var _19_valueOrError10 m_Wrappers.Result = m_JSONHelpers.Companion_Default___.Utf8EncodeMap(_18_encryptionContextStrings)
											_ = _19_valueOrError10
											if (_19_valueOrError10).IsFailure() {
												return (_19_valueOrError10).PropagateFailure()
											} else {
												var _20_encryptionContext _dafny.Map = (_19_valueOrError10).Extract().(_dafny.Map)
												_ = _20_encryptionContext
												return m_Wrappers.Companion_Result_.Create_Success_(m_EsdkTestVectors.Companion_EsdkDecryptTestVector_.Create_PositiveV4DecryptTestVector_(name, version, (op).Dtor_manifestPath(), (_7_ciphertextLoc).Drop((_dafny.IntOfUint32((Companion_Default___.FILE__PREPEND()).Cardinality())).Uint32()), (_5_plaintextLoc).Drop((_dafny.IntOfUint32((Companion_Default___.FILE__PREPEND()).Cardinality())).Uint32()), m_Wrappers.Companion_Option_.Create_Some_(_20_encryptionContext), m_Wrappers.Companion_Option_.Create_None_(), _14_keyDescription, m_AwsCryptographyMaterialProvidersTypes.Companion_ESDKCommitmentPolicy_.Create_FORBID__ENCRYPT__ALLOW__DECRYPT_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), name, m_EsdkTestVectors.Companion_DecryptionMethod_.Create_OneShot_(), _16_cmm, (op).Dtor_retryPolicy()))
											}
										}
									}
								}
