// Package WrappedESDK
// Dafny module WrappedESDK compiled into Go
...
func (_static *CompanionStruct_Default___) WrappedDefaultAwsEncryptionSdkConfig() m_AwsCryptographyEncryptionSdkTypes.AwsEncryptionSdkConfig {
...
func (_static *CompanionStruct_Default___) WrappedAwsEncryptionSdkConfigWithSuppliedCommitment(commitmentPolicy m_AwsCryptographyMaterialProvidersTypes.ESDKCommitmentPolicy) m_AwsCryptographyEncryptionSdkTypes.AwsEncryptionSdkConfig {
	return m_AwsCryptographyEncryptionSdkTypes.Companion_AwsEncryptionSdkConfig_.Create_AwsEncryptionSdkConfig_(m_Wrappers.Companion_Option_.Create_Some_(commitmentPolicy), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_())
}
func (_static *CompanionStruct_Default___) WrappedAwsEncryptionSdkConfigWithSuppliedCommitmentRetryPolicy(commitmentPolicy m_AwsCryptographyMaterialProvidersTypes.ESDKCommitmentPolicy, netV4__0__0__RetryPolicy m_AwsCryptographyEncryptionSdkTypes.NetV4__0__0__RetryPolicy) m_AwsCryptographyEncryptionSdkTypes.AwsEncryptionSdkConfig {
	return m_AwsCryptographyEncryptionSdkTypes.Companion_AwsEncryptionSdkConfig_.Create_AwsEncryptionSdkConfig_(m_Wrappers.Companion_Option_.Create_Some_(commitmentPolicy), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_Some_(netV4__0__0__RetryPolicy))
}
func (_static *CompanionStruct_Default___) WrappedAwsEncryptionSdkConfig(commitmentPolicy m_AwsCryptographyMaterialProvidersTypes.ESDKCommitmentPolicy, maxEncryptedDataKeys int64, netV4__0__0__RetryPolicy m_AwsCryptographyEncryptionSdkTypes.NetV4__0__0__RetryPolicy) m_AwsCryptographyEncryptionSdkTypes.AwsEncryptionSdkConfig {
	return m_AwsCryptographyEncryptionSdkTypes.Companion_AwsEncryptionSdkConfig_.Create_AwsEncryptionSdkConfig_(m_Wrappers.Companion_Option_.Create_Some_(commitmentPolicy), m_Wrappers.Companion_Option_.Create_Some_(maxEncryptedDataKeys), m_Wrappers.Companion_Option_.Create_Some_(netV4__0__0__RetryPolicy))
}
