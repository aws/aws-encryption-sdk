// Package AllEsdkV4WithReqEc
// Dafny module AllEsdkV4WithReqEc compiled into Go
...
func (*Default__) String() string {
	return "AllEsdkV4WithReqEc.Default__"
}
...
func (_static *CompanionStruct_Default___) AllPositiveReqEcTests() _dafny.Set {
	return m_AllRequiredEncryptionContextCmm.Companion_Default___.SuccessTestingRequiredEncryptionContextKeysReproducedEncryptionContext()
}
func (_static *CompanionStruct_Default___) FrameSize() int64 {
	return int64(512)
}
func (_static *CompanionStruct_Default___) AllPositiveReqEcEsdkTests() _dafny.Set {
	return func() _dafny.Set {
		var _coll0 = _dafny.NewBuilder()
		_ = _coll0
		for _iter5 := _dafny.Iterate((Companion_Default___.AllPositiveReqEcTests()).Elements()); ; {
			_compr_0, _ok5 := _iter5()
			if !_ok5 {
				break
			}
			var _0_config m_TestVectors.EncryptTestVector
			_0_config = interface{}(_compr_0).(m_TestVectors.EncryptTestVector)
			if (Companion_Default___.AllPositiveReqEcTests()).Contains(_0_config) {
				for _iter6 := _dafny.Iterate((m_AllAlgorithmSuites.Companion_Default___.ESDKAlgorithmSuites()).Elements()); ; {
					_compr_1, _ok6 := _iter6()
					if !_ok6 {
						break
					}
...
func (_static *CompanionStruct_Default___) Tests() _dafny.Set {
	return Companion_Default___.AllPositiveReqEcEsdkTests()
}
