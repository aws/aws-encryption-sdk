...
// Command-line arguments: translate cs --stdin --no-verify --cores 2 --optimize-erasable-datatype-wrapper false --unicode-char false --function-syntax 3 --output runtimes/net/tests/TestsFromDafny --allow-warnings --include-test-runner --compile-suffix --legacy-module-names --allow-external-contracts --library /Users/lucmcdon/workplace/aws-encryption-sdk/mpl/StandardLibrary/src/Index.dfy --library dafny/ESDKRoundTrip/src/Index.dfy
// the_program

method {:verify false} {:main} _Test__Main_(_noArgsParameter: seq<seq<char>>)
{
  var success: bool := true;
  print @""Tests3.TestVectorsV2: "";
    [[ try { ]]
{
      TestVectorsV2()
      {
...
namespace _module {
  ...
  public partial class __default {
    public static void __Test____Main__(Dafny.ISequence<Dafny.ISequence<char>> __noArgsParameter)
    {
      bool _0_success;
      _0_success = true;
      Dafny.Helpers.Print((Dafny.Sequence<char>.FromString(@"Tests3.TestVectorsV2: ")));
      try {
        {
          Tests3_Compile.__default.TestVectorsV2();
          {
...
")));
      ...
      Dafny.Helpers.Print((Dafny.Sequence<char>.FromString(@"Tests2.TestVectorsV2: ")));
      try {
        {
          Tests2_Compile.__default.TestVectorsV2();
          {
            Dafny.Helpers.Print((Dafny.Sequence<char>.FromString(@"PASSED
")));
          }
...
")));
      ...
      if (!(_0_success)) {
        throw new Dafny.HaltException("(0,-1): " + Dafny.Sequence<char>.FromString(@"Test failures occurred: see above.
"));}
    }
  }
