...
from test_vectors_v2.internaldafny.generated.ESDKTestRoundTrip import (
    ESDKTestRoundTripClient,
)
from .dafny_protocol import DafnyRequest


class DafnyImplInterface:
    impl: ESDKTestRoundTripClient | None = None
    ...
    def handle_request(self, input: DafnyRequest):
        if self.operation_map is None:
            self.operation_map = {
                "TestCrossLanguageRoundTrip": self.impl.TestCrossLanguageRoundTrip,
            }
