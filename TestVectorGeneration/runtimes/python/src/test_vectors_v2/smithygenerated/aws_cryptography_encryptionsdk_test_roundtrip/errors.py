...
import _dafny
import test_vectors_v2.internaldafny.generated
...
def _smithy_error_to_dafny_error(e: ServiceError):
    ...
    if isinstance(e, CollectionOfErrors):
        return test_vectors_v2.internaldafny.generated.AwsCryptographyEncryptionSdkTestRoundtripTypes.Error_CollectionOfErrors(
    ...
    if isinstance(e, OpaqueError):
        return test_vectors_v2.internaldafny.generated.AwsCryptographyEncryptionSdkTestRoundtripTypes.Error_Opaque(
            obj=e.obj
        )

    if isinstance(e, OpaqueWithTextError):
        return test_vectors_v2.internaldafny.generated.AwsCryptographyEncryptionSdkTestRoundtripTypes.Error_OpaqueWithText(
