...
from test_vectors_v2.internaldafny.generated.AwsCryptographyEncryptionSdkTestRoundtripTypes import (
    IESDKTestRoundTripServiceClient,
)
from typing import Callable, TypeVar, cast

from .config import Config, ESDKTestRoundTripConfig
...
from .deserialize import _deserialize_test_cross_language_round_trip
from .errors import ServiceError
from .models import TestCrossLanguageRoundTripInput, TestCrossLanguageRoundTripOutput
from .serialize import _serialize_test_cross_language_round_trip
...
class ESDKTestRoundTripService:
    """Client for ESDKTestRoundTripService.
    ...
    def __init__(
        self,
        config: ESDKTestRoundTripConfig | None = None,
        dafny_client: IESDKTestRoundTripServiceClient | None = None,
    ):
        if config is None:
            self._config = Config()
        else:
    ...
    def test_cross_language_round_trip(
        self, input: TestCrossLanguageRoundTripInput
    ) -> TestCrossLanguageRoundTripOutput:
        """Invokes the TestCrossLanguageRoundTrip operation.
        ...
        return self._execute_operation(
            input=input,
            plugins=[],
            serialize=_serialize_test_cross_language_round_trip,
            deserialize=_deserialize_test_cross_language_round_trip,
            config=self._config,
