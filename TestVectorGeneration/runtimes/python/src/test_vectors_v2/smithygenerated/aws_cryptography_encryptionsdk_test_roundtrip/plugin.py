...
def set_config_impl(config: Config):
    ...
    if isinstance(config, ESDKTestRoundTripConfig):
        from test_vectors_v2.internaldafny.generated.ESDKTestRoundTrip import default__

        config.dafnyImplInterface.impl = default__.ESDKTestRoundTrip(
