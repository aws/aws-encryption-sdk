...
class default__:
    ...
    def PartitionMemberships(x):
        return _dafny.Seq([CreateRawAesKeyringInput.default__.IsValidMember((x).RawAes)])

    @staticmethod
    def RepresentativeValues():
        output: _dafny.Seq = _dafny.Seq({})
        d_0_res1_: _dafny.Seq
        out0_: _dafny.Seq
        out0_ = CreateRawAesKeyringInput.default__.GetValues()
        d_0_res1_ = out0_
        d_1_out1_: _dafny.Seq
        d_1_out1_ = _dafny.Seq([])
        hi0_ = len(d_0_res1_)
        for d_2_i_ in range(0, hi0_):
            d_1_out1_ = (d_1_out1_) + (_dafny.Seq([AwsCryptographyEncryptionSdkTestRoundtripTypes.SupportedKeyringCreateInputs_RawAes((d_0_res1_)[d_2_i_])]))
        output = d_1_out1_
        return output
    ...
    def ToJSON(x):
        source0_ = x
        if True:
            return JSON_Values.JSON_Object(_dafny.Seq([(_dafny.Seq("RawAes"), CreateRawAesKeyringInput.default__.ToJSON((x).RawAes))]))
    ...
    def GenerateJSON():
        ...
        for d_2_i_ in range(0, hi0_):
            d_3_value_: AwsCryptographyEncryptionSdkTestRoundtripTypes.SupportedKeyringCreateInputs
    ...
    @staticmethod
    def SomeValue():
        output: AwsCryptographyEncryptionSdkTestRoundtripTypes.SupportedKeyringCreateInputs = AwsCryptographyEncryptionSdkTestRoundtripTypes.SupportedKeyringCreateInputs.default()()
        d_0_values_: _dafny.Seq
        out0_: _dafny.Seq
        out0_ = default__.GetValues()
        d_0_values_ = out0_
    ...
    def AddIfNotPruned(x, vals):
        output: _dafny.Seq = _dafny.Seq({})
        d_0_replace_: AwsCryptographyEncryptionSdkTestRoundtripTypes.SupportedKeyringCreateInputs
        out0_: AwsCryptographyEncryptionSdkTestRoundtripTypes.SupportedKeyringCreateInputs
