...
# Module: DecryptInputPartitioning
...
class default__:
    ...
    def PartitionMemberships(x):
        return _dafny.Seq([(OptionalEncryptionContextPartitioning.default__.IsValidMember((x).encryptionContext)) and (OptionalKeyringPartitioning.default__.IsValidMember((x).keyring))])

    @staticmethod
    def RepresentativeValues():
        output: _dafny.Seq = _dafny.Seq({})
        d_0_values2_: _dafny.Seq
        out0_: _dafny.Seq
        out0_ = OptionalEncryptionContextPartitioning.default__.GetValues()
        d_0_values2_ = out0_
        _dafny.print(_dafny.string_of(_dafny.Seq("|OptionalEncryptionContextPartitioning.GetValues()| = ")))
        _dafny.print(_dafny.string_of(len(d_0_values2_)))
        _dafny.print(_dafny.string_of(_dafny.Seq("\n")))
        d_1_values3_: _dafny.Seq
        out1_: _dafny.Seq
        out1_ = OptionalKeyringPartitioning.default__.GetValues()
        d_1_values3_ = out1_
        _dafny.print(_dafny.string_of(_dafny.Seq("|OptionalKeyringPartitioning.GetValues()| = ")))
        _dafny.print(_dafny.string_of(len(d_1_values3_)))
        _dafny.print(_dafny.string_of(_dafny.Seq("\n")))
        output = _dafny.Seq([])
        hi0_ = len(d_0_values2_)
        for d_2_j_ in range(0, hi0_):
            hi1_ = len(d_1_values3_)
            for d_3_k_ in range(0, hi1_):
                output = (output) + (_dafny.Seq([AwsCryptographyEncryptionSdkTestRoundtripTypes.RoundTripDecryptInput_RoundTripDecryptInput((d_0_values2_)[d_2_j_], (d_1_values3_)[d_3_k_])]))
                if (len(output)) >= (100):
                    output = output
                    return output
        return output
    ...
    @staticmethod
    def ToJSON(x):
        return JSON_Values.JSON_Object(_dafny.Seq([(_dafny.Seq("encryptionContext"), OptionalEncryptionContextPartitioning.default__.ToJSON((x).encryptionContext)), (_dafny.Seq("keyring"), OptionalKeyringPartitioning.default__.ToJSON((x).keyring))]))
    ...
    def GenerateJSON():
        ...
        for d_2_i_ in range(0, hi0_):
            d_3_value_: AwsCryptographyEncryptionSdkTestRoundtripTypes.RoundTripDecryptInput
    ...
    @staticmethod
    def SomeValue():
        output: AwsCryptographyEncryptionSdkTestRoundtripTypes.RoundTripDecryptInput = AwsCryptographyEncryptionSdkTestRoundtripTypes.RoundTripDecryptInput.default()()
        d_0_values_: _dafny.Seq
        out0_: _dafny.Seq
        out0_ = default__.GetValues()
        d_0_values_ = out0_
    ...
    def AddIfNotPruned(x, vals):
        output: _dafny.Seq = _dafny.Seq({})
        d_0_replace_: AwsCryptographyEncryptionSdkTestRoundtripTypes.RoundTripDecryptInput
        out0_: AwsCryptographyEncryptionSdkTestRoundtripTypes.RoundTripDecryptInput
