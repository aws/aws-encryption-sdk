...
# Module: StringLengthPartitioning
...
class default__:
    ...
    def PartitionMemberships(x):
        return _dafny.Seq([EmptyStringPartition.default__.IsInPartition(x), NonemptyStringPartition.default__.IsInPartition(x)])
    ...
    def RepresentativeValues():
        ...
        out1_: _dafny.Seq
        out1_ = NonemptyStringPartition.default__.GetValues()
        d_1_values2_ = out1_
