...
class default__:
    ...
    @staticmethod
    def ValueSpaceList():
        return _dafny.Seq([AwsCryptographyMaterialProvidersTypes.AesWrappingAlg_ALG__AES128__GCM__IV12__TAG16(), AwsCryptographyMaterialProvidersTypes.AesWrappingAlg_ALG__AES192__GCM__IV12__TAG16(), AwsCryptographyMaterialProvidersTypes.AesWrappingAlg_ALG__AES256__GCM__IV12__TAG16()])

    @staticmethod
    def ToJSON(x):
        if (x) == (AwsCryptographyMaterialProvidersTypes.AesWrappingAlg_ALG__AES128__GCM__IV12__TAG16()):
            return JSON_Values.JSON_String(_dafny.Seq("ALG_AES128_GCM_IV12_TAG16"))
        elif (x) == (AwsCryptographyMaterialProvidersTypes.AesWrappingAlg_ALG__AES192__GCM__IV12__TAG16()):
            return JSON_Values.JSON_String(_dafny.Seq("ALG_AES192_GCM_IV12_TAG16"))
        elif (x) == (AwsCryptographyMaterialProvidersTypes.AesWrappingAlg_ALG__AES256__GCM__IV12__TAG16()):
            return JSON_Values.JSON_String(_dafny.Seq("ALG_AES256_GCM_IV12_TAG16"))
        elif True:
            return JSON_Values.JSON_String(_dafny.Seq("UnknownWrappingAlg"))

    @staticmethod
    def ValueSpaceEqualityList(x):
        return _dafny.Seq([(x) == (AwsCryptographyMaterialProvidersTypes.AesWrappingAlg_ALG__AES128__GCM__IV12__TAG16()), (x) == (AwsCryptographyMaterialProvidersTypes.AesWrappingAlg_ALG__AES192__GCM__IV12__TAG16()), (x) == (AwsCryptographyMaterialProvidersTypes.AesWrappingAlg_ALG__AES256__GCM__IV12__TAG16())])
    ...
    @staticmethod
    def SomeValue():
        output: AwsCryptographyMaterialProvidersTypes.AesWrappingAlg = AwsCryptographyMaterialProvidersTypes.AesWrappingAlg.default()()
    ...
    def AddIfNotPruned(x, vals):
        output: _dafny.Seq = _dafny.Seq({})
        d_0_replace_: AwsCryptographyMaterialProvidersTypes.AesWrappingAlg
        out0_: AwsCryptographyMaterialProvidersTypes.AesWrappingAlg
