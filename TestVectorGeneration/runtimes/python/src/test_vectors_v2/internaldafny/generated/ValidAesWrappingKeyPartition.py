...
# Module: ValidAesWrappingKeyPartition
...
class default__:
    ...
    @staticmethod
    def IsInPartition(x):
        return ((Aes128WrappingKeyPartition.default__.IsInPartition(x)) or (Aes192WrappingKeyPartition.default__.IsInPartition(x))) or (Aes256WrappingKeyPartition.default__.IsInPartition(x))

    @staticmethod
    def RepresentativeValues():
        output: _dafny.Seq = _dafny.Seq({})
        d_0_validAes128_: _dafny.Seq
        out0_: _dafny.Seq
        out0_ = Aes128WrappingKeyPartition.default__.GetValues()
        d_0_validAes128_ = out0_
        d_1_validAes192_: _dafny.Seq
        out1_: _dafny.Seq
        out1_ = Aes192WrappingKeyPartition.default__.GetValues()
        d_1_validAes192_ = out1_
        d_2_validAes256_: _dafny.Seq
        out2_: _dafny.Seq
        out2_ = Aes256WrappingKeyPartition.default__.GetValues()
        d_2_validAes256_ = out2_
        output = ((d_0_validAes128_) + (d_1_validAes192_)) + (d_2_validAes256_)
        return output
