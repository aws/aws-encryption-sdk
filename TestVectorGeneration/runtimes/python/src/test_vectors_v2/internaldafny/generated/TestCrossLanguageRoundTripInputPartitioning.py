...
# Module: TestCrossLanguageRoundTripInputPartitioning
...
class default__:
    ...
    def PartitionMemberships(x):
        return _dafny.Seq([(EncryptInputPartitioning.default__.IsValidMember((x).encryptInput)) and (DecryptInputPartitioning.default__.IsValidMember((x).decryptInput))])
    ...
    def RepresentativeValues():
        ...
        out0_: _dafny.Seq
        out0_ = EncryptInputPartitioning.default__.GetValues()
        d_0_values1_ = out0_
        d_1_values2_: _dafny.Seq
        out1_: _dafny.Seq
        out1_ = DecryptInputPartitioning.default__.GetValues()
        d_1_values2_ = out1_
        output = _dafny.Seq([])
        hi0_ = len(d_0_values1_)
        for d_2_i_ in range(0, hi0_):
            hi1_ = len(d_1_values2_)
            for d_3_j_ in range(0, hi1_):
                d_4_val_: AwsCryptographyEncryptionSdkTestRoundtripTypes.TestCrossLanguageRoundTripInput
                d_4_val_ = AwsCryptographyEncryptionSdkTestRoundtripTypes.TestCrossLanguageRoundTripInput_TestCrossLanguageRoundTripInput(AwsCryptographyEncryptionSdkTestRoundtripTypes.ImplementationLanguage_PYTHON(), AwsCryptographyEncryptionSdkTestRoundtripTypes.ImplementationLanguage_PYTHON(), (d_0_values1_)[d_2_i_], (d_1_values2_)[d_3_j_])
                out2_: _dafny.Seq
                out2_ = default__.MaybeAddValToVals(d_4_val_, output)
                output = out2_
        return output

    @staticmethod
    def ReplaceList(x):
        output: AwsCryptographyEncryptionSdkTestRoundtripTypes.TestCrossLanguageRoundTripInput = AwsCryptographyEncryptionSdkTestRoundtripTypes.TestCrossLanguageRoundTripInput.default()()
        output = x
        if ((((output).encryptInput).keyring).is_Some) and (ValidKeyIdentifierPruningConfiguration.default__.MatchesPruningConfiguration(((((output).encryptInput).keyring).value).RawAes)):
            d_0_newRawAes_: AwsCryptographyMaterialProvidersTypes.CreateRawAesKeyringInput
            out0_: AwsCryptographyMaterialProvidersTypes.CreateRawAesKeyringInput
            out0_ = ValidKeyIdentifierPruningConfiguration.default__.RepresentativeValue(((((output).encryptInput).keyring).value).RawAes)
            d_0_newRawAes_ = out0_
            output = AwsCryptographyEncryptionSdkTestRoundtripTypes.TestCrossLanguageRoundTripInput_TestCrossLanguageRoundTripInput((output).encryptLanguage, (output).decryptLanguage, AwsCryptographyEncryptionSdkTestRoundtripTypes.RoundTripEncryptInput_RoundTripEncryptInput(((output).encryptInput).plaintext, ((output).encryptInput).encryptionContext, Wrappers.Option_Some(AwsCryptographyEncryptionSdkTestRoundtripTypes.SupportedKeyringCreateInputs_RawAes(d_0_newRawAes_)), ((output).encryptInput).algorithmSuiteId, ((output).encryptInput).frameLength), (output).decryptInput)
        if ((((output).decryptInput).keyring).is_Some) and (ValidKeyIdentifierPruningConfiguration.default__.MatchesPruningConfiguration(((((output).decryptInput).keyring).value).RawAes)):
            d_1_newRawAes_: AwsCryptographyMaterialProvidersTypes.CreateRawAesKeyringInput
            out1_: AwsCryptographyMaterialProvidersTypes.CreateRawAesKeyringInput
            out1_ = ValidKeyIdentifierPruningConfiguration.default__.RepresentativeValue(((((output).decryptInput).keyring).value).RawAes)
            d_1_newRawAes_ = out1_
            output = AwsCryptographyEncryptionSdkTestRoundtripTypes.TestCrossLanguageRoundTripInput_TestCrossLanguageRoundTripInput((output).encryptLanguage, (output).decryptLanguage, (output).encryptInput, AwsCryptographyEncryptionSdkTestRoundtripTypes.RoundTripDecryptInput_RoundTripDecryptInput(((output).encryptInput).encryptionContext, Wrappers.Option_Some(AwsCryptographyEncryptionSdkTestRoundtripTypes.SupportedKeyringCreateInputs_RawAes(d_1_newRawAes_))))
        if ((((output).encryptInput).keyring).is_Some) and (InvalidKeyIdentifierPruningConfiguration.default__.MatchesPruningConfiguration(((((output).encryptInput).keyring).value).RawAes)):
            d_2_newRawAes_: AwsCryptographyMaterialProvidersTypes.CreateRawAesKeyringInput
            out2_: AwsCryptographyMaterialProvidersTypes.CreateRawAesKeyringInput
            out2_ = InvalidKeyIdentifierPruningConfiguration.default__.RepresentativeValue(((((output).encryptInput).keyring).value).RawAes)
            d_2_newRawAes_ = out2_
            output = AwsCryptographyEncryptionSdkTestRoundtripTypes.TestCrossLanguageRoundTripInput_TestCrossLanguageRoundTripInput((output).encryptLanguage, (output).decryptLanguage, AwsCryptographyEncryptionSdkTestRoundtripTypes.RoundTripEncryptInput_RoundTripEncryptInput(((output).encryptInput).plaintext, ((output).encryptInput).encryptionContext, Wrappers.Option_Some(AwsCryptographyEncryptionSdkTestRoundtripTypes.SupportedKeyringCreateInputs_RawAes(d_2_newRawAes_)), ((output).encryptInput).algorithmSuiteId, ((output).encryptInput).frameLength), (output).decryptInput)
        elif True:
            output = output
            return output
        return output
    ...
    @staticmethod
    def ToJSON(x):
        return JSON_Values.JSON_Object(_dafny.Seq([(_dafny.Seq("encryptLanguage"), JSON_Values.JSON_String(_dafny.Seq("PYTHON"))), (_dafny.Seq("decryptLanguage"), JSON_Values.JSON_String(_dafny.Seq("PYTHON"))), (_dafny.Seq("encrypt"), EncryptInputPartitioning.default__.ToJSON((x).encryptInput)), (_dafny.Seq("decrypt"), DecryptInputPartitioning.default__.ToJSON((x).decryptInput))]))

    @staticmethod
    def MaybeAddValToVals(x, vals):
        output: _dafny.Seq = _dafny.Seq({})
        d_0_replace_: AwsCryptographyEncryptionSdkTestRoundtripTypes.TestCrossLanguageRoundTripInput
        out0_: AwsCryptographyEncryptionSdkTestRoundtripTypes.TestCrossLanguageRoundTripInput
        out0_ = default__.ReplaceList(x)
        d_0_replace_ = out0_
        if (x) == (d_0_replace_):
    ...
    def GenerateJSON():
        ...
        for d_2_i_ in range(0, hi0_):
            d_3_value_: AwsCryptographyEncryptionSdkTestRoundtripTypes.TestCrossLanguageRoundTripInput
