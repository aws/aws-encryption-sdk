...
# Module: CreateRawAesKeyringTestService
...
class default__:
    ...
    def GenerateOperationsJSON():
        ...
        d_0_CreateRawAesKeyringSmokeTestJSON_: JSON_Values.JSON
        out0_: JSON_Values.JSON
        out0_ = CreateRawAesKeyringSmokeTest.default__.GenerateJSON()
        d_0_CreateRawAesKeyringSmokeTestJSON_ = out0_
        operationsJSON = JSON_Values.JSON_Array(_dafny.Seq([d_0_CreateRawAesKeyringSmokeTestJSON_]))
    ...
    def serviceName(instance):
        return _dafny.Seq("CreateRawAesKeyringTestService")
