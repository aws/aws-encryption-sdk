...
# Module: KeyNamespacePartitioningScheme
...
class default__:
    ...
    def PartitionMemberships(x):
        return _dafny.Seq([InvalidRawAesKeyNamespacePartition.default__.IsInPartition(x), ValidRawAesKeyNamespacePartition.default__.IsInPartition(x)])

    @staticmethod
    def RepresentativeValues():
        output: _dafny.Seq = _dafny.Seq({})
        d_0_invalidValues_: _dafny.Seq
        out0_: _dafny.Seq
        out0_ = InvalidRawAesKeyNamespacePartition.default__.GetValues()
        d_0_invalidValues_ = out0_
        d_1_validValues_: _dafny.Seq
        out1_: _dafny.Seq
        out1_ = ValidRawAesKeyNamespacePartition.default__.GetValues()
        d_1_validValues_ = out1_
        output = (d_0_invalidValues_) + (d_1_validValues_)
        return output
