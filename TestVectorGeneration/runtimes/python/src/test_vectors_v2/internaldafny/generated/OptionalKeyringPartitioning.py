...
# Module: OptionalKeyringPartitioning
...
class default__:
    ...
    def PartitionMemberships(x):
        return _dafny.Seq([OptionNoneKeyringPartitioning.default__.IsValidMember(x), OptionSomeKeyringPartitioning.default__.IsValidMember(x)])
    ...
    def RepresentativeValues():
        ...
        out0_: _dafny.Seq
        out0_ = OptionNoneKeyringPartitioning.default__.GetValues()
        d_0_values1_ = out0_
        d_1_values2_: _dafny.Seq
        out1_: _dafny.Seq
        out1_ = OptionSomeKeyringPartitioning.default__.GetValues()
        d_1_values2_ = out1_
    ...
    def ToJSON(x):
        if (x).is_None:
            ...
            return JSON_Values.JSON_Object(_dafny.Seq([(_dafny.Seq("Some"), KeyringPartitioning.default__.ToJSON((x).value))]))
