...
class default__:
    ...
    @staticmethod
    def TestVectorsV2():
        d_0_CreateRawAesKeyringInputJSON_: JSON_Values.JSON
        out0_: JSON_Values.JSON
        out0_ = CreateRawAesKeyringInput.default__.GenerateJSON()
        d_0_CreateRawAesKeyringInputJSON_ = out0_
        d_1_out_: Wrappers.Result
        out1_: Wrappers.Result
        out1_ = TestVectorGeneration.default__.WriteVectorsFile(_dafny.Seq("CreateRawAesKeyringInput.json"), d_0_CreateRawAesKeyringInputJSON_)
        d_1_out_ = out1_
        d_2_CreateRawAesKeyringSmokeTestJSON_: JSON_Values.JSON
        out2_: JSON_Values.JSON
        out2_ = CreateRawAesKeyringSmokeTest.default__.GenerateJSON()
        d_2_CreateRawAesKeyringSmokeTestJSON_ = out2_
        d_3_out2_: Wrappers.Result
        out3_: Wrappers.Result
        out3_ = TestVectorGeneration.default__.WriteVectorsFile(_dafny.Seq("CreateRawAesKeyringSmokeTest.json"), d_2_CreateRawAesKeyringSmokeTestJSON_)
        d_3_out2_ = out3_
        d_4_CreateRawAesKeyringTestServiceJSON_: JSON_Values.JSON
        out4_: JSON_Values.JSON
        out4_ = CreateRawAesKeyringTestService.default__.GenerateJSON()
        d_4_CreateRawAesKeyringTestServiceJSON_ = out4_
        d_5_out3_: Wrappers.Result
        out5_: Wrappers.Result
        out5_ = TestVectorGeneration.default__.WriteVectorsFile(_dafny.Seq("CreateRawAesKeyringTestService.json"), d_4_CreateRawAesKeyringTestServiceJSON_)
        d_5_out3_ = out5_
