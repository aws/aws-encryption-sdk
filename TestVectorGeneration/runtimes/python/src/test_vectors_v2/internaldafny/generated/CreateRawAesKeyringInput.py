...
# Module: CreateRawAesKeyringInput
...
class default__:
    ...
    def PartitionMemberships(x):
        return _dafny.Seq([(((AesWrappingKeyPartitioningScheme.default__.IsValidMember((x).wrappingKey)) and (WrappingAlgValues.default__.IsValidMember((x).wrappingAlg))) and (KeyNamespacePartitioningScheme.default__.IsValidMember((x).keyNamespace))) and (KeyNamePartitioningScheme.default__.IsValidMember((x).keyName))])

    @staticmethod
    def PruningConfigurationList(x):
        output: _dafny.Seq = _dafny.Seq({})
        d_0_invalidAes128_: tuple
        out0_: tuple
        out0_ = InvalidAes128PruningConfiguration.default__.PruningConfiguration(x)
        d_0_invalidAes128_ = out0_
        d_1_invalidAes192_: tuple
        out1_: tuple
        out1_ = InvalidAes192PruningConfiguration.default__.PruningConfiguration(x)
        d_1_invalidAes192_ = out1_
        d_2_invalidAes256_: tuple
        out2_: tuple
        out2_ = InvalidAes256PruningConfiguration.default__.PruningConfiguration(x)
        d_2_invalidAes256_ = out2_
        output = _dafny.Seq([d_0_invalidAes128_, d_1_invalidAes192_, d_2_invalidAes256_])
        return output
        output = _dafny.Seq([])
        return output
        return output
    ...
    def RepresentativeValues():
        output: _dafny.Seq = _dafny.Seq({})
        d_0_wrappingKeys_: _dafny.Seq
        out0_: _dafny.Seq
        out0_ = AesWrappingKeyPartitioningScheme.default__.GetValues()
        d_0_wrappingKeys_ = out0_
        d_1_wrappingAlgs_: _dafny.Seq
        out1_: _dafny.Seq
        out1_ = WrappingAlgValues.default__.GetValues()
        d_1_wrappingAlgs_ = out1_
        d_2_keyNamespaces_: _dafny.Seq
        out2_: _dafny.Seq
        out2_ = KeyNamespacePartitioningScheme.default__.GetValues()
        d_2_keyNamespaces_ = out2_
        d_3_keyNames_: _dafny.Seq
        out3_: _dafny.Seq
        out3_ = KeyNamePartitioningScheme.default__.GetValues()
        d_3_keyNames_ = out3_
        output = _dafny.Seq([])
        hi0_ = len(d_1_wrappingAlgs_)
        for d_4_i_ in range(0, hi0_):
            hi1_ = len(d_0_wrappingKeys_)
            for d_5_j_ in range(0, hi1_):
                hi2_ = len(d_2_keyNamespaces_)
                for d_6_k_ in range(0, hi2_):
                    hi3_ = len(d_3_keyNames_)
                    for d_7_l_ in range(0, hi3_):
                        d_8_keyring_: AwsCryptographyMaterialProvidersTypes.CreateRawAesKeyringInput
                        d_8_keyring_ = AwsCryptographyMaterialProvidersTypes.CreateRawAesKeyringInput_CreateRawAesKeyringInput((d_2_keyNamespaces_)[d_6_k_], (d_3_keyNames_)[d_7_l_], (d_0_wrappingKeys_)[d_5_j_], (d_1_wrappingAlgs_)[d_4_i_])
                        out4_: _dafny.Seq
                        out4_ = default__.AddIfNotPruned(d_8_keyring_, output)
                        output = out4_
        if (len(output)) == (0):
            output = _dafny.Seq([AwsCryptographyMaterialProvidersTypes.CreateRawAesKeyringInput_CreateRawAesKeyringInput(_dafny.Seq("default"), _dafny.Seq("default"), _dafny.Seq([0]), AwsCryptographyMaterialProvidersTypes.AesWrappingAlg_ALG__AES128__GCM__IV12__TAG16())])
        return output

    @staticmethod
    def ToJSON(x):
        return JSON_Values.JSON_Object(_dafny.Seq([(_dafny.Seq("wrappingKey"), AesWrappingKeyPartitioningScheme.default__.ToJSON((x).wrappingKey)), (_dafny.Seq("wrappingAlg"), WrappingAlgValues.default__.ToJSON((x).wrappingAlg)), (_dafny.Seq("keyNamespace"), KeyNamespacePartitioningScheme.default__.ToJSON((x).keyNamespace)), (_dafny.Seq("keyName"), KeyNamePartitioningScheme.default__.ToJSON((x).keyName))]))
    ...
    def GenerateJSON():
        ...
        for d_2_i_ in range(0, hi0_):
            d_3_value_: AwsCryptographyMaterialProvidersTypes.CreateRawAesKeyringInput
    ...
    @staticmethod
    def SomeValue():
        output: AwsCryptographyMaterialProvidersTypes.CreateRawAesKeyringInput = AwsCryptographyMaterialProvidersTypes.CreateRawAesKeyringInput.default()()
        d_0_values_: _dafny.Seq
        out0_: _dafny.Seq
        out0_ = default__.GetValues()
        d_0_values_ = out0_
    ...
    def AddIfNotPruned(x, vals):
        output: _dafny.Seq = _dafny.Seq({})
        d_0_replace_: AwsCryptographyMaterialProvidersTypes.CreateRawAesKeyringInput
