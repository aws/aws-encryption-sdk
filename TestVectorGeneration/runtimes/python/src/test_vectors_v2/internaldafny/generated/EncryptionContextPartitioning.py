...
# Module: EncryptionContextPartitioning
...
class default__:
    ...
    def PartitionMemberships(x):
        return _dafny.Seq([EmptyEncryptionContextPartition.default__.IsValidMember(x), NomemptyEncryptionContextPartition.default__.IsValidMember(x)])
    ...
    def RepresentativeValues():
        ...
        out0_: _dafny.Seq
        out0_ = EmptyEncryptionContextPartition.default__.GetValues()
        d_0_values1_ = out0_
        d_1_values2_: _dafny.Seq
        out1_: _dafny.Seq
        out1_ = NomemptyEncryptionContextPartition.default__.GetValues()
        d_1_values2_ = out1_
    ...
    @staticmethod
    def ToJSON(x):
        return JSON_Values.JSON_String(_dafny.Seq("TODO implement ToJSON for EncryptionContext"))
