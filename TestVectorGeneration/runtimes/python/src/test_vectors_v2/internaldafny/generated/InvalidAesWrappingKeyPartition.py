...
# Module: InvalidAesWrappingKeyPartition
...
class default__:
    ...
    @staticmethod
    def IsInPartition(x):
        return not(((Aes128WrappingKeyPartition.default__.IsInPartition(x)) or (Aes192WrappingKeyPartition.default__.IsInPartition(x))) or (Aes256WrappingKeyPartition.default__.IsInPartition(x)))

    @staticmethod
    def RepresentativeValues():
        output: _dafny.Seq = _dafny.Seq({})
        output = _dafny.Seq([_dafny.Seq([]), _dafny.Seq([0])])
        return output
