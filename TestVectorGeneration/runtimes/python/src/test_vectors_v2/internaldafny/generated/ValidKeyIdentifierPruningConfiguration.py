...
# Module: ValidKeyIdentifierPruningConfiguration
...
class default__:
    ...
    def MatchesPruningConfiguration(x):
        return (ValidRawAesKeyNamespacePartition.default__.IsValidMember((x).keyNamespace)) and (KeyNamePartitioningScheme.default__.IsValidMember((x).keyName))
    ...
    def RepresentativeValue(input):
        ...
        out1_: _dafny.Seq
        out1_ = ValidRawAesKeyNamespacePartition.default__.SomeValue()
