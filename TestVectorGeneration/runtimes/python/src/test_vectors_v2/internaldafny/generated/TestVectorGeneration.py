...
class default__:
    ...
    @staticmethod
    def WriteVectorsFile(location, json):
        ...
        def lambda0_(d_1_e_):
            return (d_1_e_).ToString()

        d_0_valueOrError0_ = (JSON_API.default__.Serialize(json)).MapFailure(lambda0_)
        if (d_0_valueOrError0_).IsFailure():
            output = (d_0_valueOrError0_).PropagateFailure()
            return output
        d_2_jsonBytes_: _dafny.Seq
        d_2_jsonBytes_ = (d_0_valueOrError0_).Extract()
        out0_: Wrappers.Result
        out0_ = FileIO.default__.WriteBytesToFile(location, d_2_jsonBytes_)
        output = out0_
        return output
