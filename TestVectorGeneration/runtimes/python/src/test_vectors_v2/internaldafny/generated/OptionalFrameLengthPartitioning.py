...
# Module: OptionalFrameLengthPartitioning
...
class default__:
    ...
    def PartitionMemberships(x):
        return _dafny.Seq([OptionalFrameLengthSomePartitioning.default__.IsValidMember(x), OptionalFrameLengthNonePartitioning.default__.IsValidMember(x)])
    ...
    def RepresentativeValues():
        ...
        out0_: _dafny.Seq
        out0_ = OptionalFrameLengthSomePartitioning.default__.GetValues()
        d_0_values1_ = out0_
        d_1_values2_: _dafny.Seq
        out1_: _dafny.Seq
        out1_ = OptionalFrameLengthNonePartitioning.default__.GetValues()
        d_1_values2_ = out1_
    ...
    def ToJSON(x):
        if (x).is_None:
            ...
            return JSON_Values.JSON_Object(_dafny.Seq([(_dafny.Seq("Some"), JSON_Values.JSON_Number(JSON_Values.default__.Int((x).value)))]))
