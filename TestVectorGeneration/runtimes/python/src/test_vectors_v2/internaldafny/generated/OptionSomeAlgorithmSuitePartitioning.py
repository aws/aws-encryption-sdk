...
# Module: OptionSomeAlgorithmSuitePartitioning
...
class default__:
    ...
    def RepresentativeValues():
        ...
        out0_: _dafny.Seq
        out0_ = ESDKAlgorithmSuitePartitioning.default__.GetValues()
        d_0_values1_ = out0_
        d_1_values_: _dafny.Seq
        d_1_values_ = d_0_values1_
        d_2_temp_: _dafny.Seq
        d_2_temp_ = _dafny.Seq([])
        d_3_i_: int
        d_3_i_ = 0
        while (d_3_i_) < (len(d_1_values_)):
            d_2_temp_ = (d_2_temp_) + (_dafny.Seq([Wrappers.Option_Some((d_1_values_)[d_3_i_])]))
            d_3_i_ = (d_3_i_) + (1)
        output = d_2_temp_
        return output
    ...
    @staticmethod
    def IsValidMember(x):
        return default__.IsInPartition(x)
