...
# Module: TestCrossLanguageRoundTrip
...
class default__:
    ...
    def DomainRepresentativeValues():
        ...
        out0_: _dafny.Seq
        out0_ = TestCrossLanguageRoundTripInputPartitioning.default__.GetValues()
        output = out0_
        return output

    @staticmethod
    def EvaluationRule(x):
        output: AwsCryptographyEncryptionSdkTestRoundtripTypes.TestCrossLanguageRoundTripOutput = AwsCryptographyEncryptionSdkTestRoundtripTypes.TestCrossLanguageRoundTripOutput.default()()
        if (((x).encryptInput).encryptionContext) != (((x).decryptInput).encryptionContext):
            output = AwsCryptographyEncryptionSdkTestRoundtripTypes.TestCrossLanguageRoundTripOutput_TestCrossLanguageRoundTripOutput(_dafny.Seq("encryption context mismatch"))
            return output
        elif True:
            output = AwsCryptographyEncryptionSdkTestRoundtripTypes.TestCrossLanguageRoundTripOutput_TestCrossLanguageRoundTripOutput(_dafny.Seq("ok"))
            return output
        return output

    @staticmethod
    def InputToJSON(x):
        return TestCrossLanguageRoundTripInputPartitioning.default__.ToJSON(x)

    @staticmethod
    def OutputToJSON(x):
        return JSON_Values.JSON_String((x).status)
    ...
    def GenerateJSON():
        ...
        for d_2_i_ in range(0, hi0_):
            d_3_input_: AwsCryptographyEncryptionSdkTestRoundtripTypes.TestCrossLanguageRoundTripInput
    ...
    def JSONToWriteForOperationInputValue(input):
        ...
        d_0_outputValue_: AwsCryptographyEncryptionSdkTestRoundtripTypes.TestCrossLanguageRoundTripOutput
        out0_: AwsCryptographyEncryptionSdkTestRoundtripTypes.TestCrossLanguageRoundTripOutput
    ...
    def operationName(instance):
        return _dafny.Seq("TestCrossLanguageRoundTrip")
