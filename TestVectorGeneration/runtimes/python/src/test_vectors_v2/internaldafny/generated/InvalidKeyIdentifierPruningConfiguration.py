...
# Module: InvalidKeyIdentifierPruningConfiguration
...
class default__:
    ...
    def MatchesPruningConfiguration(x):
        return (InvalidRawAesKeyNamespacePartition.default__.IsValidMember((x).keyNamespace)) and (KeyNamePartitioningScheme.default__.IsValidMember((x).keyName))
    ...
    def RepresentativeValue(input):
        ...
        d_0_keyName_: _dafny.Seq
        out0_: _dafny.Seq
        out0_ = KeyNamePartitioningScheme.default__.SomeValue()
        d_0_keyName_ = out0_
        d_1_keyNamespace_: _dafny.Seq
        out1_: _dafny.Seq
        out1_ = InvalidRawAesKeyNamespacePartition.default__.SomeValue()
        d_1_keyNamespace_ = out1_
        output = AwsCryptographyMaterialProvidersTypes.CreateRawAesKeyringInput_CreateRawAesKeyringInput(d_1_keyNamespace_, d_0_keyName_, (input).wrappingKey, (input).wrappingAlg)
        return output
