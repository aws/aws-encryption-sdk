...
# Module: InvalidAes192PruningConfiguration
...
class default__:
    ...
    @staticmethod
    def MatchesPruningConfiguration(x):
        return (((x).wrappingAlg) == (AwsCryptographyMaterialProvidersTypes.AesWrappingAlg_ALG__AES192__GCM__IV12__TAG16())) and (not(Aes192WrappingKeyPartition.default__.IsInPartition((x).wrappingKey)))

    @staticmethod
    def RepresentativeValue(input):
        ...
        d_0_representativeKeyNamespace_: _dafny.Seq
        out0_: _dafny.Seq
        out0_ = ValidRawAesKeyNamespacePartition.default__.SomeValue()
        d_0_representativeKeyNamespace_ = out0_
        d_1_representativeKeyName_: _dafny.Seq
        out1_: _dafny.Seq
        out1_ = KeyNamePartitioningScheme.default__.SomeValue()
        d_1_representativeKeyName_ = out1_
        d_2_wrappingKey_: _dafny.Seq
        out2_: _dafny.Seq
        out2_ = InvalidAesWrappingKeyPartition.default__.SomeValue()
        d_2_wrappingKey_ = out2_
        output = AwsCryptographyMaterialProvidersTypes.CreateRawAesKeyringInput_CreateRawAesKeyringInput(d_0_representativeKeyNamespace_, d_1_representativeKeyName_, d_2_wrappingKey_, AwsCryptographyMaterialProvidersTypes.AesWrappingAlg_ALG__AES192__GCM__IV12__TAG16())
        return output

    @staticmethod
    def MaybeReplaceWithRepresentativeValue(x):
        output: AwsCryptographyMaterialProvidersTypes.CreateRawAesKeyringInput = AwsCryptographyMaterialProvidersTypes.CreateRawAesKeyringInput.default()()
        if default__.MatchesPruningConfiguration(x):
            out0_: AwsCryptographyMaterialProvidersTypes.CreateRawAesKeyringInput
            out0_ = default__.RepresentativeValue(x)
            output = out0_
        elif True:
            output = x
        return output
    ...
    @staticmethod
    def PruningConfiguration(x):
        output: tuple = (False, AwsCryptographyMaterialProvidersTypes.CreateRawAesKeyringInput.default()())
        d_0_matches_: bool
        d_0_matches_ = default__.MatchesPruningConfiguration(x)
        d_1_value_: AwsCryptographyMaterialProvidersTypes.CreateRawAesKeyringInput
        out0_: AwsCryptographyMaterialProvidersTypes.CreateRawAesKeyringInput
        out0_ = default__.RepresentativeValue(x)
        d_1_value_ = out0_
        output = (d_0_matches_, d_1_value_)
        return output
