...
# Module: NomemptyEncryptionContextPartition
...
class default__:
    ...
    def RepresentativeValues():
        ...
        d_0_aResult_: Wrappers.Result
        d_0_aResult_ = UTF8.default__.Encode(_dafny.Seq("abc"))
        d_1_bResult_: Wrappers.Result
        d_1_bResult_ = UTF8.default__.Encode(_dafny.Seq("def"))
        if ((d_0_aResult_).is_Success) and ((d_1_bResult_).is_Success):
            d_2_a_: _dafny.Seq
            d_2_a_ = (d_0_aResult_).value
            d_3_b_: _dafny.Seq
            d_3_b_ = (d_1_bResult_).value
            output = _dafny.Seq([_dafny.Map({d_2_a_: d_3_b_})])
        elif True:
            output = _dafny.Seq([])
        return output
