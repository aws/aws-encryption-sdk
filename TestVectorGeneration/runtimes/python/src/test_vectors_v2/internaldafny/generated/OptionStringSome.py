...
class default__:
    ...
    def RepresentativeValues():
        ...
        out0_: _dafny.Seq
        out0_ = StringLengthPartitioning.default__.GetValues()
        d_0_values1_ = out0_
        d_1_values2_: _dafny.Seq
        out1_: _dafny.Seq
        out1_ = BasicStringPartitioning.default__.GetValues()
        d_1_values2_ = out1_
        d_2_values_: _dafny.Seq
        d_2_values_ = (d_0_values1_) + (d_1_values2_)
        d_3_temp_: _dafny.Seq
        d_3_temp_ = _dafny.Seq([])
        d_4_i_: int
        d_4_i_ = 0
        while (d_4_i_) < (len(d_2_values_)):
            d_3_temp_ = (d_3_temp_) + (_dafny.Seq([Wrappers.Option_Some((d_2_values_)[d_4_i_])]))
            d_4_i_ = (d_4_i_) + (1)
        output = d_3_temp_
        return output
