...
# Module: BasicStringPartitioning
...
class default__:
    ...
    def PartitionMemberships(x):
        return _dafny.Seq([EmptyStringPartition.default__.IsInPartition(x), AsciiPartition.default__.IsInPartition(x), NonAsciiPartition.default__.IsInPartition(x)])
    ...
    def RepresentativeValues():
        ...
        out0_: _dafny.Seq
        out0_ = EmptyStringPartition.default__.GetValues()
        d_0_values1_ = out0_
        d_1_values2_: _dafny.Seq
        out1_: _dafny.Seq
        out1_ = AsciiPartition.default__.GetValues()
        d_1_values2_ = out1_
        d_2_values3_: _dafny.Seq
        out2_: _dafny.Seq
        out2_ = NonAsciiPartition.default__.GetValues()
        d_2_values3_ = out2_
        output = ((d_0_values1_) + (d_1_values2_)) + (d_2_values3_)
        return output
