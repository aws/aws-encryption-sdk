...
# Module: InvalidAes256PruningConfiguration
...
class default__:
    ...
    def MatchesPruningConfiguration(x):
        return (((x).wrappingAlg) == (AwsCryptographyMaterialProvidersTypes.AesWrappingAlg_ALG__AES256__GCM__IV12__TAG16())) and (not(Aes256WrappingKeyPartition.default__.IsInPartition((x).wrappingKey)))
    ...
    def RepresentativeValue(input):
        ...
        output = AwsCryptographyMaterialProvidersTypes.CreateRawAesKeyringInput_CreateRawAesKeyringInput(d_0_representativeKeyNamespace_, d_1_representativeKeyName_, d_2_wrappingKey_, AwsCryptographyMaterialProvidersTypes.AesWrappingAlg_ALG__AES256__GCM__IV12__TAG16())
        return output
