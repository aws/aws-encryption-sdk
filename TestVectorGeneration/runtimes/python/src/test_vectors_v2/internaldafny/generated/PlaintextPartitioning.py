...
class default__:
    ...
    def PartitionMemberships(x):
        return _dafny.Seq([EmptyPlaintextPartitioning.default__.IsValidMember(x), NonemptyPlaintextPartitioning.default__.IsValidMember(x)])
    ...
    def RepresentativeValues():
        ...
        out0_: _dafny.Seq
        out0_ = EmptyPlaintextPartitioning.default__.GetValues()
        d_0_values1_ = out0_
        d_1_values2_: _dafny.Seq
        out1_: _dafny.Seq
        out1_ = NonemptyPlaintextPartitioning.default__.GetValues()
        d_1_values2_ = out1_
