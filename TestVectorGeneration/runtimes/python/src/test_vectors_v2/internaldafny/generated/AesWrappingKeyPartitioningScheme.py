...
# Module: AesWrappingKeyPartitioningScheme
...
class default__:
    ...
    def PartitionMemberships(x):
        return _dafny.Seq([ValidAesWrappingKeyPartition.default__.IsInPartition(x), InvalidAesWrappingKeyPartition.default__.IsInPartition(x)])

    @staticmethod
    def RepresentativeValues():
        output: _dafny.Seq = _dafny.Seq({})
        d_0_validAes_: _dafny.Seq
        out0_: _dafny.Seq
        out0_ = ValidAesWrappingKeyPartition.default__.GetValues()
        d_0_validAes_ = out0_
        d_1_invalidAes_: _dafny.Seq
        out1_: _dafny.Seq
        out1_ = InvalidAesWrappingKeyPartition.default__.GetValues()
        d_1_invalidAes_ = out1_
        output = (d_0_validAes_) + (d_1_invalidAes_)
        return output

    @staticmethod
    def ToJSON(x):
        return JSON_Values.JSON_String(Base64.default__.Encode(x))
