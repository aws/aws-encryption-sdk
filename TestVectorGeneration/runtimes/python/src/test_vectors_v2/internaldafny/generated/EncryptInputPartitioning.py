...
# Module: EncryptInputPartitioning
...
class default__:
    ...
    def PartitionMemberships(x):
        return _dafny.Seq([((((PlaintextPartitioning.default__.IsValidMember((x).plaintext)) and (OptionalEncryptionContextPartitioning.default__.IsValidMember((x).encryptionContext))) and (OptionalKeyringPartitioning.default__.IsValidMember((x).keyring))) and (OptionalESDKAlgorithmSuitePartitioning.default__.IsValidMember((x).algorithmSuiteId))) and (OptionalFrameLengthPartitioning.default__.IsValidMember((x).frameLength))])
    ...
    def RepresentativeValues():
        ...
        out0_: _dafny.Seq
        out0_ = PlaintextPartitioning.default__.GetValues()
        d_0_values1_ = out0_
        _dafny.print(_dafny.string_of(_dafny.Seq("|PlaintextPartitioning.GetValues()| = ")))
        _dafny.print(_dafny.string_of(len(d_0_values1_)))
        _dafny.print(_dafny.string_of(_dafny.Seq("\n")))
        d_1_values2_: _dafny.Seq
        out1_: _dafny.Seq
        out1_ = OptionalEncryptionContextPartitioning.default__.GetValues()
        d_1_values2_ = out1_
        _dafny.print(_dafny.string_of(_dafny.Seq("|OptionalEncryptionContextPartitioning.GetValues()| = ")))
        _dafny.print(_dafny.string_of(len(d_1_values2_)))
        _dafny.print(_dafny.string_of(_dafny.Seq("\n")))
        d_2_values3_: _dafny.Seq
        out2_: _dafny.Seq
        out2_ = OptionalKeyringPartitioning.default__.GetValues()
        d_2_values3_ = out2_
        _dafny.print(_dafny.string_of(_dafny.Seq("|OptionalKeyringPartitioning.GetValues()| = ")))
        _dafny.print(_dafny.string_of(len(d_2_values3_)))
        _dafny.print(_dafny.string_of(_dafny.Seq("\n")))
        d_3_values4_: _dafny.Seq
        out3_: _dafny.Seq
        out3_ = OptionalESDKAlgorithmSuitePartitioning.default__.GetValues()
        d_3_values4_ = out3_
        _dafny.print(_dafny.string_of(_dafny.Seq("|OptionalESDKAlgorithmSuitePartitioning.GetValues()| = ")))
        _dafny.print(_dafny.string_of(len(d_3_values4_)))
        _dafny.print(_dafny.string_of(_dafny.Seq("\n")))
        d_4_values5_: _dafny.Seq
        out4_: _dafny.Seq
        out4_ = OptionalFrameLengthPartitioning.default__.GetValues()
        d_4_values5_ = out4_
        _dafny.print(_dafny.string_of(_dafny.Seq("|OptionalFrameLengthPartitioning.GetValues()| = ")))
        _dafny.print(_dafny.string_of(len(d_4_values5_)))
        _dafny.print(_dafny.string_of(_dafny.Seq("\n")))
        output = _dafny.Seq([])
        hi0_ = len(d_0_values1_)
        for d_5_i_ in range(0, hi0_):
            hi1_ = len(d_1_values2_)
            for d_6_j_ in range(0, hi1_):
                hi2_ = len(d_2_values3_)
                for d_7_k_ in range(0, hi2_):
                    hi3_ = len(d_3_values4_)
                    for d_8_l_ in range(0, hi3_):
                        hi4_ = len(d_4_values5_)
                        for d_9_m_ in range(0, hi4_):
                            output = (output) + (_dafny.Seq([AwsCryptographyEncryptionSdkTestRoundtripTypes.RoundTripEncryptInput_RoundTripEncryptInput((d_0_values1_)[d_5_i_], (d_1_values2_)[d_6_j_], (d_2_values3_)[d_7_k_], (d_3_values4_)[d_8_l_], (d_4_values5_)[d_9_m_])]))
                            if (len(output)) >= (100):
                                output = output
                                return output
        return output
    ...
    @staticmethod
    def ToJSON(x):
        return JSON_Values.JSON_Object(_dafny.Seq([(_dafny.Seq("plaintext"), PlaintextPartitioning.default__.ToJSON((x).plaintext)), (_dafny.Seq("encryptionContext"), OptionalEncryptionContextPartitioning.default__.ToJSON((x).encryptionContext)), (_dafny.Seq("keyring"), OptionalKeyringPartitioning.default__.ToJSON((x).keyring)), (_dafny.Seq("algorithmSuiteId"), OptionalESDKAlgorithmSuitePartitioning.default__.ToJSON((x).algorithmSuiteId)), (_dafny.Seq("frameLength"), OptionalFrameLengthPartitioning.default__.ToJSON((x).frameLength))]))
    ...
    def GenerateJSON():
        ...
        for d_2_i_ in range(0, hi0_):
            d_3_value_: AwsCryptographyEncryptionSdkTestRoundtripTypes.RoundTripEncryptInput
    ...
    @staticmethod
    def SomeValue():
        output: AwsCryptographyEncryptionSdkTestRoundtripTypes.RoundTripEncryptInput = AwsCryptographyEncryptionSdkTestRoundtripTypes.RoundTripEncryptInput.default()()
        d_0_values_: _dafny.Seq
        out0_: _dafny.Seq
        out0_ = default__.GetValues()
        d_0_values_ = out0_
    ...
    def AddIfNotPruned(x, vals):
        output: _dafny.Seq = _dafny.Seq({})
        d_0_replace_: AwsCryptographyEncryptionSdkTestRoundtripTypes.RoundTripEncryptInput
        out0_: AwsCryptographyEncryptionSdkTestRoundtripTypes.RoundTripEncryptInput
