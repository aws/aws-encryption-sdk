...
# Module: InvalidAes128PruningConfiguration
...
class default__:
    ...
    def MatchesPruningConfiguration(x):
        return (((x).wrappingAlg) == (AwsCryptographyMaterialProvidersTypes.AesWrappingAlg_ALG__AES128__GCM__IV12__TAG16())) and (not(Aes128WrappingKeyPartition.default__.IsInPartition((x).wrappingKey)))
    ...
    def RepresentativeValue(input):
        ...
        out2_: _dafny.Seq
        out2_ = Aes192WrappingKeyPartition.default__.SomeValue()
        d_2_wrappingKey_ = out2_
        output = AwsCryptographyMaterialProvidersTypes.CreateRawAesKeyringInput_CreateRawAesKeyringInput(d_0_representativeKeyNamespace_, d_1_representativeKeyName_, d_2_wrappingKey_, AwsCryptographyMaterialProvidersTypes.AesWrappingAlg_ALG__AES128__GCM__IV12__TAG16())
        return output
