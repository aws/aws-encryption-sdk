...
class default__:
    ...
    @staticmethod
    def TestRTTVectors():
        d_0_outputJSON_: JSON_Values.JSON
        out0_: JSON_Values.JSON
        out0_ = TestCrossLanguageRoundTrip.default__.GenerateJSON()
        d_0_outputJSON_ = out0_
        d_1_out_: Wrappers.Result
        out1_: Wrappers.Result
        out1_ = TestVectorGeneration.default__.WriteVectorsFile(_dafny.Seq("TestCrossLanguageRoundTrip.json"), d_0_outputJSON_)
        d_1_out_ = out1_
