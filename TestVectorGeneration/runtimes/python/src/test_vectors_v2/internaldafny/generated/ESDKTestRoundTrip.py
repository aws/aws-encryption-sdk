...
class default__:
    ...
    @staticmethod
    def GenerateOperationsJSON():
        operationsJSON: JSON_Values.JSON = JSON_Values.JSON.default()()
        d_0_TestCrossLanguageRoundTripJSON_: JSON_Values.JSON
        out0_: JSON_Values.JSON
        out0_ = TestCrossLanguageRoundTrip.default__.GenerateJSON()
        d_0_TestCrossLanguageRoundTripJSON_ = out0_
        operationsJSON = JSON_Values.JSON_Array(_dafny.Seq([d_0_TestCrossLanguageRoundTripJSON_]))
        return operationsJSON

    @staticmethod
    def GenerateJSON():
        outputJSON: JSON_Values.JSON = JSON_Values.JSON.default()()
        d_0_operationsJSON_: JSON_Values.JSON
        out0_: JSON_Values.JSON
        out0_ = default__.GenerateOperationsJSON()
        d_0_operationsJSON_ = out0_
        outputJSON = JSON_Values.JSON_Object(_dafny.Seq([(((default__.serviceNamespace) + (_dafny.Seq(":"))) + (default__.serviceName), d_0_operationsJSON_)]))
        return outputJSON

    @_dafny.classproperty
    def serviceNamespace(instance):
        return _dafny.Seq("aws.cryptography.encryptionSdk.test.roundtrip")
    @_dafny.classproperty
    def serviceName(instance):
        return _dafny.Seq("ESDKTestRoundTrip")
