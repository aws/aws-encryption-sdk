...
impl Encrypt {
    ...
    ) -> ::std::result::Result<crate::operation::encrypt::EncryptOutput, crate::types::error::Error>
    {
        ...
        let inner_result = ::dafny_runtime::md!(client.dafny_client.clone()).Encrypt(&inner_input);
        if matches!(
            inner_result.as_ref(),
            crate::r#_Wrappers_Compile::Result::Success { .. }
        ) {
            Ok(crate::conversions::encrypt::_encrypt_output::from_dafny(
