...
use aws_mpl_legacy::dafny::com_amazonaws_kms::client::Client as kms_client;
use aws_mpl_legacy::dafny::operation::get_client::GetClientInput;
use aws_mpl_legacy::dafny::types::ClientSupplier;
